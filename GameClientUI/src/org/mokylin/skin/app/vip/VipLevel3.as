package org.mokylin.skin.app.vip
{
	...
	import org.mokylin.skin.app.vip.button.ButtonZhizun;
	 ...
	 */
	public class VipLevel3 extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		public function VipLevel3()
		{
			...
			this.height = 94;
			this.width = 190;
			this.elementsContent = [btnVip_i(),icon_i(),uiVip_i(),__VipLevel3_UIAsset1_i(),lbJiage_i(),btnKaitong_i(),uiSelect_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __VipLevel3_UIAsset1_i():feathers.controls.UIAsset
		{
		...
		private function btnVip_i():feathers.controls.Button
		{
			...
			btnVip = temp;
			temp.name = "btnVip";
			temp.styleClass = org.mokylin.skin.app.vip.button.ButtonZhizun;
			temp.x = 0;
			temp.y = 0;
			return temp;
		}
		...
		private function uiSelect_i():feathers.controls.UIAsset
		{
			...
			temp.touchable = false;
			temp.touchGroup = true;
			temp.styleName = "ui/app/vip/select/zuanshikuang.png";
			temp.width = 190;
			temp.x = 0;
			temp.y = 0;
			return temp;
		...
		private function uiVip_i():feathers.controls.UIAsset
		{
			...
			temp.touchable = false;
			temp.touchGroup = true;
			temp.styleName = "ui/app/vip/vip/zhizun.png";
			temp.x = 15;
			temp.y = 39;
			return temp;
		}
