package org.mokylin.skin.app.tips
{
	 ...
	 */
	public class mouseHandTips2Skin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function mouseHandTips2Skin()
		{
			super();
			...
			this.height = 37;
			this.width = 273;
			this.elementsContent = [__mouseHandTips2Skin_UIAsset1_i(),lbl_name_i(),lbl_name0_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __mouseHandTips2Skin_UIAsset1_i():feathers.controls.UIAsset
		{
