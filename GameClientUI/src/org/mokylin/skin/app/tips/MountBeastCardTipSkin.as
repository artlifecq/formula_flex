package org.mokylin.skin.app.tips
{
	 ...
	 */
	public class MountBeastCardTipSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function MountBeastCardTipSkin()
		{
			super();
		...
		//                                定义成员方法
		//==========================================================================
		private function __MountBeastCardTipSkin_UIAsset1_i():feathers.controls.UIAsset
		{
		...
		private function groupTitle_i():feathers.controls.Group
		{
			...
			temp.x = 8;
			temp.y = 8;
			temp.elementsContent = [__MountBeastCardTipSkin_UIAsset1_i(),imgIcon_i(),labName_i(),labType_i(),labDecTitle_i(),labLevel_i()];
			return temp;
		}
