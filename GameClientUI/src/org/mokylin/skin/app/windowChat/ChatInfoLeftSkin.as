package org.mokylin.skin.app.windowChat
{
	 ...
	 */
	public class ChatInfoLeftSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function ChatInfoLeftSkin()
		{
			super();
		...
		private function textBg_i():feathers.controls.UIAsset
		{
			...
			temp.name = "textBg";
			temp.height = 52;
			temp.styleName = "ui/common/version_3/B_bujian/dui_hua_kuang_zuo.png";
			temp.width = 360;
			temp.x = 0;
			temp.y = 26;
			return temp;
