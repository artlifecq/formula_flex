package org.mokylin.skin.app.crown
{
	 ...
	 */
	public class CrownQiuJinSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function CrownQiuJinSkin()
		{
			super();
			
			this.currentState = "normal";
			this.elementsContent = [__CrownQiuJinSkin_UIAsset1_i(),btn_i(),__CrownQiuJinSkin_UIAsset2_i(),closeBtn_i(),__CrownQiuJinSkin_UIAsset3_i(),__CrownQiuJinSkin_UIAsset4_i(),__CrownQiuJinSkin_Label1_i(),playerName_i(),timeGroup_i(),title_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __CrownQiuJinSkin_HorizontalLayout1_i():feathers.layout.HorizontalLayout
		{
		...
		private function __CrownQiuJinSkin_Label1_i():feathers.controls.Label
		{
		...
		private function __CrownQiuJinSkin_UIAsset1_i():feathers.controls.UIAsset
		{
		...
		private function __CrownQiuJinSkin_UIAsset2_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function __CrownQiuJinSkin_UIAsset3_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.height = 142;
		...
		private function __CrownQiuJinSkin_UIAsset4_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function timeGroup_i():feathers.controls.Group
		{
			...
			temp.x = 40;
			temp.y = 110;
			temp.layout = __CrownQiuJinSkin_HorizontalLayout1_i();
			return temp;
		}
