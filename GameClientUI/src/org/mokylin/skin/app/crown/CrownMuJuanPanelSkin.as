package org.mokylin.skin.app.crown
{
	 ...
	 */
	public class CrownMuJuanPanelSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function CrownMuJuanPanelSkin()
		{
			super();
			
			this.currentState = "normal";
			this.elementsContent = [__CrownMuJuanPanelSkin_UIAsset1_i(),__CrownMuJuanPanelSkin_UIAsset2_i(),__CrownMuJuanPanelSkin_UIAsset3_i(),__CrownMuJuanPanelSkin_Label1_i(),__CrownMuJuanPanelSkin_Label2_i(),__CrownMuJuanPanelSkin_UIAsset4_i(),closeBtn_i(),title_i(),btn_i(),juankuanLbl_i(),group_i(),des_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __CrownMuJuanPanelSkin_HorizontalLayout1_i():feathers.layout.HorizontalLayout
		{
		...
		private function __CrownMuJuanPanelSkin_Label1_i():feathers.controls.Label
		{
		...
		private function __CrownMuJuanPanelSkin_Label2_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			temp.bold = false;
			temp.height = 25;
		...
		private function __CrownMuJuanPanelSkin_UIAsset1_i():feathers.controls.UIAsset
		{
		...
		private function __CrownMuJuanPanelSkin_UIAsset2_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.height = 152;
		...
		private function __CrownMuJuanPanelSkin_UIAsset3_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.height = 105;
		...
		private function __CrownMuJuanPanelSkin_UIAsset4_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function group_i():feathers.controls.Group
		{
			...
			temp.x = 57;
			temp.y = 123;
			temp.layout = __CrownMuJuanPanelSkin_HorizontalLayout1_i();
