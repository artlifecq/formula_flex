package org.mokylin.skin.app.beibao
{
	 ...
	 */
	public class beibao_bakSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		public var txt_miaoshang:feathers.controls.Label;
		...
		//                                定义构造函数
		//==========================================================================
		public function beibao_bakSkin()
		{
			super();
			...
			this.height = 587;
			this.width = 947;
			this.elementsContent = [bg_i(),__beibao_bakSkin_UIAsset1_i(),__beibao_bakSkin_UIAsset2_i(),headMsg_i(),weapons_i(),footMsg_i(),values_i(),packs_i(),btn_nv_i(),btnClose_i()];
		...
		private function __beibao_bakSkin_ArrayCollection1_i():feathers.data.ListCollection
		{
		...
		private function __beibao_bakSkin_Group1_i():feathers.controls.Group
		{
			var temp:feathers.controls.Group = new feathers.controls.Group();
			temp.x = 11;
			temp.y = 109;
		...
		private function __beibao_bakSkin_HorizontalLayout1_i():feathers.layout.HorizontalLayout
		{
		...
		private function __beibao_bakSkin_Label1_i():feathers.controls.Label
		{
		...
		private function __beibao_bakSkin_Label2_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			temp.bold = true;
			temp.fontSize = 16;
		...
		private function __beibao_bakSkin_Label3_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			temp.fontSize = 12;
			temp.text = "基础属性";
		...
		private function __beibao_bakSkin_TileLayout1_i():feathers.layout.TiledRowsLayout
		{
			var temp:feathers.layout.TiledRowsLayout = new feathers.layout.TiledRowsLayout();
			return temp;
		}

		private function __beibao_bakSkin_UIAsset10_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function __beibao_bakSkin_UIAsset11_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.styleName = "ui/app/beibao/fengexian.png";
			temp.width = 333;
		...
		private function __beibao_bakSkin_UIAsset12_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function __beibao_bakSkin_UIAsset13_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.height = 23;
			temp.styleName = "ui/app/beibao/neikuang.png";
		...
		private function __beibao_bakSkin_UIAsset14_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.styleName = "ui/app/beibao/neikuang.png";
			temp.width = 128;
		...
		private function __beibao_bakSkin_UIAsset15_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.height = 23;
			temp.styleName = "ui/app/beibao/neikuang.png";
		...
		private function __beibao_bakSkin_UIAsset1_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function __beibao_bakSkin_UIAsset2_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function __beibao_bakSkin_UIAsset5_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function __beibao_bakSkin_UIAsset6_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function __beibao_bakSkin_UIAsset7_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.height = 449;
		...
		private function __beibao_bakSkin_UIAsset8_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.height = 421;
		...
		private function __beibao_bakSkin_UIAsset9_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function footMsg_i():feathers.controls.Group
		{
			...
			temp.x = 237;
			temp.y = 485;
			temp.elementsContent = [__beibao_bakSkin_UIAsset3_i(),__beibao_bakSkin_UIAsset4_i(),__beibao_bakSkin_UIAsset5_i(),Num_zhandouli_i()];
			return temp;
		}
		...
		private function lst_pack_i():feathers.controls.List
		{
			...
			temp.x = 8;
			temp.y = 32;
			temp.layout = __beibao_bakSkin_TileLayout1_i();
			return temp;
		}
		...
		private function money_i():feathers.controls.Group
		{
			...
			temp.x = 12;
			temp.y = 349;
			temp.elementsContent = [__beibao_bakSkin_UIAsset12_i(),__beibao_bakSkin_UIAsset13_i(),__beibao_bakSkin_UIAsset14_i(),__beibao_bakSkin_UIAsset15_i(),txt_yingzi_i(),txt_yuanbao_i(),txt_yingzibang_i(),txt_lijin_i(),icon_yingzi_i(),icon_yuanbao_i(),icon_yingzibang_i(),icon_lijin_i()];
			return temp;
		}
		...
		private function packs_i():feathers.controls.Group
		{
			...
			temp.x = 588;
			temp.y = 74;
			temp.elementsContent = [__beibao_bakSkin_UIAsset7_i(),__beibao_bakSkin_UIAsset8_i(),__beibao_bakSkin_UIAsset9_i(),__beibao_bakSkin_UIAsset10_i(),__beibao_bakSkin_UIAsset11_i(),tab_pack_i(),money_i(),Icons_i(),lst_pack_i()];
			return temp;
		}
		...
		private function tab_pack_i():feathers.controls.TabBar
		{
			...
			temp.x = 9;
			temp.y = 0;
			temp.layout = __beibao_bakSkin_HorizontalLayout1_i();
			temp.dataProvider = __beibao_bakSkin_ArrayCollection1_i();
			return temp;
		}
		...
		private function txt_miaoshang_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			txt_miaoshang = temp;
			temp.name = "txt_miaoshang";
			temp.bold = true;
			temp.fontSize = 18;
			temp.text = "64777777";
			temp.color = 0xF2B13B;
		...
		private function values_i():feathers.controls.Group
		{
			...
			temp.x = 27;
			temp.y = 75;
			temp.elementsContent = [__beibao_bakSkin_UIAsset6_i(),__beibao_bakSkin_Label1_i(),__beibao_bakSkin_Label2_i(),txt_miaoshang_i(),__beibao_bakSkin_Label3_i(),lbl_jingyan_i(),lbl_zhenqi_i(),pro_jinyan_i(),pro_zhenqi_i(),txt_jinyan_i(),txt_zhenqi_i(),__beibao_bakSkin_Group1_i(),txt_i()];
			return temp;
		}
		...
		private function weapons_i():feathers.controls.Group
		{
			...
			temp.x = 232;
			temp.y = 159;
			temp.elementsContent = [Icbg0_i(),Icbg5_i(),Icbg1_i(),Icbg6_i(),Icbg2_i(),Icbg7_i(),Icbg3_i(),Icbg8_i(),Icbg4_i(),Icbg9_i()];
			return temp;
		}
