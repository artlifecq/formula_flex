package org.mokylin.skin.app.beibao
{
	...
	public class beibao_Skin extends feathers.controls.StateSkin
	{
		...
		public var btn_shuxing:feathers.controls.Button;

		public var btn_taozhuang:feathers.controls.Button;
		...
		public function beibao_Skin()
		{
			...
			this.height = 587;
			this.width = 947;
			this.elementsContent = [__beibao_Skin_UIAsset5_i(),__beibao_Skin_UIAsset6_i(),headMsg_i(),weapons_i(),footMsg_i(),values_i(),packs_i(),btn_nv_i(),__beibao_Skin_UIAsset22_i(),btn_close_i()];
		...
		private function __beibao_Skin_Group2_i():feathers.controls.Group
		{
			var temp:feathers.controls.Group = new feathers.controls.Group();
			temp.x = 11;
			temp.y = 109;
		...
		private function __beibao_Skin_TileLayout1_i():feathers.layout.TiledRowsLayout
		{
		...
		private function __beibao_Skin_UIAsset19_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.height = 23;
			temp.styleName = "ui/app/beibao/neikuang.png";
		...
		private function __beibao_Skin_UIAsset20_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.styleName = "ui/app/beibao/neikuang.png";
			temp.width = 128;
		...
		private function __beibao_Skin_UIAsset21_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.height = 23;
			temp.styleName = "ui/app/beibao/neikuang.png";
		...
		private function __beibao_Skin_UIAsset22_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function btn_nv_i():feathers.controls.Group
		{
			...
			temp.x = 20;
			temp.y = 533;
			temp.elementsContent = [btn_taozhuang_i(),btn_shuxing_i()];
			return temp;
		}
		...
		private function btn_shuxing_i():feathers.controls.Button
		{
			var temp:feathers.controls.Button = new feathers.controls.Button();
			btn_shuxing = temp;
			temp.name = "btn_shuxing";
		...
		private function btn_taozhuang_i():feathers.controls.Button
		{
			var temp:feathers.controls.Button = new feathers.controls.Button();
			btn_taozhuang = temp;
			temp.name = "btn_taozhuang";
		...
		private function footMsg_i():feathers.controls.Group
		{
			...
			temp.x = 237;
			temp.y = 485;
			temp.elementsContent = [__beibao_Skin_UIAsset9_i(),__beibao_Skin_UIAsset10_i(),__beibao_Skin_UIAsset11_i(),Num_zhandouli_i()];
			return temp;
		}
		...
		private function lst_pack_i():feathers.controls.List
		{
			...
			temp.x = 8;
			temp.y = 32;
			temp.layout = __beibao_Skin_TileLayout1_i();
			return temp;
		}
		...
		private function money_i():feathers.controls.Group
		{
			...
			temp.x = 12;
			temp.y = 349;
			temp.elementsContent = [__beibao_Skin_UIAsset18_i(),__beibao_Skin_UIAsset19_i(),__beibao_Skin_UIAsset20_i(),__beibao_Skin_UIAsset21_i(),txt_yingzi_i(),txt_yuanbao_i(),txt_yingzibang_i(),txt_lijin_i(),icon_yingzi_i(),icon_yuanbao_i(),icon_yingzibang_i(),icon_lijin_i()];
			return temp;
		}
		...
		private function packs_i():feathers.controls.Group
		{
			...
			temp.x = 588;
			temp.y = 74;
			temp.elementsContent = [__beibao_Skin_UIAsset13_i(),__beibao_Skin_UIAsset14_i(),__beibao_Skin_UIAsset15_i(),__beibao_Skin_UIAsset16_i(),__beibao_Skin_UIAsset17_i(),tab_pack_i(),money_i(),Icons_i(),lst_pack_i()];
			return temp;
		}
		...
		private function values_i():feathers.controls.Group
		{
			...
			temp.x = 27;
			temp.y = 75;
			temp.elementsContent = [__beibao_Skin_UIAsset12_i(),__beibao_Skin_Label1_i(),__beibao_Skin_Label2_i(),txt_miaoshang_i(),__beibao_Skin_Label3_i(),lbl_jingyan_i(),lbl_zhenqi_i(),pro_jinyan_i(),pro_zhenqi_i(),txt_jinyan_i(),txt_zhenqi_i(),__beibao_Skin_Group2_i(),txt_i()];
			return temp;
		}
		...
		private function weapons_i():feathers.controls.Group
		{
			...
			temp.x = 232;
			temp.y = 159;
			temp.elementsContent = [__beibao_Skin_UIAsset7_i(),__beibao_Skin_UIAsset8_i(),Icbg0_i(),Icbg5_i(),Icbg1_i(),Icbg6_i(),Icbg2_i(),Icbg7_i(),Icbg3_i(),Icbg8_i(),Icbg4_i(),Icbg9_i()];
			return temp;
		}
