package org.mokylin.skin.app.beibao.jingmai
{
	...
	public class yinqiaomai_Skin extends feathers.controls.StateSkin
	{
		...
		public function yinqiaomai_Skin()
		{
			...
			this.height = 325;
			this.width = 325;
			this.elementsContent = [__yinqiaomai_Skin_UIAsset1_i(),grp_line_i(),grp_icon_i(),grp_label_i()];
		...
		private function __yinqiaomai_Skin_UIAsset1_i():feathers.controls.UIAsset
		{
			...
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai.png";
			temp.x = 0;
			temp.y = 0;
			return temp;
		}
		...
		private function grp_icon_i():feathers.controls.Group
		{
			...
			temp.x = 22;
			temp.y = 19;
			temp.elementsContent = [ico_1_i(),ico_16_i(),ico_17_i(),ico_3_i(),ico_2_i(),ico_4_i(),ico_5_i(),ico_6_i(),ico_7_i(),ico_8_i(),ico_11_i(),ico_12_i(),ico_13_i(),ico_14_i(),ico_15_i(),ico_10_i(),ico_9_i()];
			return temp;
		}
		...
		private function grp_label_i():feathers.controls.Group
		{
			...
			temp.x = 18;
			temp.y = 10;
			temp.elementsContent = [lb_1_i(),lb_17_i(),lb_10_i(),lb_2_i(),lb_3_i(),lb_4_i(),lb_5_i(),lb_6_i(),lb_7_i(),lb_8_i(),lb_9_i(),lb_11_i(),lb_12_i(),lb_13_i(),lb_14_i(),lb_15_i(),lb_16_i()];
			return temp;
		}
		...
		private function l_10_i():feathers.controls.UIAsset
		{
			...
			l_10 = temp;
			temp.name = "l_10";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/10.png";
			temp.x = 119;
			temp.y = 18;
			return temp;
		}
		...
		private function l_11_i():feathers.controls.UIAsset
		{
			...
			l_11 = temp;
			temp.name = "l_11";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/11.png";
			temp.x = 138;
			temp.y = 0;
			return temp;
		}
		...
		private function l_12_i():feathers.controls.UIAsset
		{
			...
			l_12 = temp;
			temp.name = "l_12";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/12.png";
			temp.x = 215;
			temp.y = 51;
			return temp;
		}
		...
		private function l_13_i():feathers.controls.UIAsset
		{
			...
			l_13 = temp;
			temp.name = "l_13";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/13.png";
			temp.x = 214;
			temp.y = 139;
			return temp;
		}
		...
		private function l_14_i():feathers.controls.UIAsset
		{
			...
			l_14 = temp;
			temp.name = "l_14";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/14.png";
			temp.x = 181;
			temp.y = 177;
			return temp;
		}
		...
		private function l_15_i():feathers.controls.UIAsset
		{
			...
			l_15 = temp;
			temp.name = "l_15";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/15.png";
			temp.x = 175;
			temp.y = 141;
			return temp;
		}
		...
		private function l_16_i():feathers.controls.UIAsset
		{
			...
			l_16 = temp;
			temp.name = "l_16";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/16.png";
			temp.x = 172;
			temp.y = 95;
			return temp;
		}
		...
		private function l_1_i():feathers.controls.UIAsset
		{
			...
			l_1 = temp;
			temp.name = "l_1";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/1.png";
			temp.x = 73;
			temp.y = 124;
			return temp;
		}
		...
		private function l_2_i():feathers.controls.UIAsset
		{
			...
			l_2 = temp;
			temp.name = "l_2";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/2.png";
			temp.x = 61;
			temp.y = 140;
			return temp;
		}
		...
		private function l_3_i():feathers.controls.UIAsset
		{
			...
			l_3 = temp;
			temp.name = "l_3";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/3.png";
			temp.x = 87;
			temp.y = 177;
			return temp;
		}
		...
		private function l_4_i():feathers.controls.UIAsset
		{
			...
			l_4 = temp;
			temp.name = "l_4";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/4.png";
			temp.x = 119;
			temp.y = 206;
			return temp;
		}
		...
		private function l_5_i():feathers.controls.UIAsset
		{
			...
			l_5 = temp;
			temp.name = "l_5";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/5.png";
			temp.x = 51;
			temp.y = 216;
			return temp;
		}
		...
		private function l_6_i():feathers.controls.UIAsset
		{
			...
			l_6 = temp;
			temp.name = "l_6";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/6.png";
			temp.x = 1;
			temp.y = 140;
			return temp;
		}
		...
		private function l_7_i():feathers.controls.UIAsset
		{
			...
			l_7 = temp;
			temp.name = "l_7";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/7.png";
			temp.x = 0;
			temp.y = 49;
			return temp;
		}
		...
		private function l_8_i():feathers.controls.UIAsset
		{
			...
			l_8 = temp;
			temp.name = "l_8";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/8.png";
			temp.x = 46;
			temp.y = 47;
			return temp;
		}
		...
		private function l_9_i():feathers.controls.UIAsset
		{
			...
			l_9 = temp;
			temp.name = "l_9";
			temp.styleName = "ui/app/beibao/jingmai/yinqiaomai/9.png";
			temp.x = 90;
			temp.y = 63;
			return temp;
		}
