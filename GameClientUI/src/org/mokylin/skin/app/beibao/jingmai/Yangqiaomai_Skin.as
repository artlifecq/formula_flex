package org.mokylin.skin.app.beibao.jingmai
{
	...
	public class Yangqiaomai_Skin extends feathers.controls.StateSkin
	{
		...
		public var ico17:feathers.controls.UIAsset;
		...
		private function grp_icon_i():feathers.controls.Group
		{
			...
			temp.x = 76;
			temp.y = 42;
			temp.elementsContent = [ico1_i(),ico16_i(),ico3_i(),ico2_i(),ico7_i(),ico11_i(),ico8_i(),ico12_i(),ico13_i(),ico10_i(),ico9_i(),ico6_i(),ico5_i(),ico4_i(),ico17_i(),ico14_i(),ico15_i()];
			return temp;
		}
		...
		private function grp_icondi_i():feathers.controls.Group
		{
			...
			temp.x = 67;
			temp.y = 34;
			temp.elementsContent = [icd1_i(),icd16_i(),icd3_i(),icd2_i(),icd7_i(),icd11_i(),icd8_i(),icd12_i(),icd13_i(),icd10_i(),icd9_i(),icd6_i(),icd5_i(),icd4_i(),icd17_i(),icd14_i(),icd15_i()];
			return temp;
		}
		...
		private function ico17_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			ico17 = temp;
			temp.name = "ico17";
