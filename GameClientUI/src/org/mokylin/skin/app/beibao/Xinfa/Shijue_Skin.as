package org.mokylin.skin.app.beibao.Xinfa
{
	 ...
	 */
	public class Shijue_Skin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		private function grp_icon_i():feathers.controls.Group
		{
			...
			temp.x = 103;
			temp.y = 43;
			temp.elementsContent = [ico_2_i(),ico_3_i(),ico_1_i(),ico_9_i(),ico_8_i(),ico_7_i(),ico_6_i(),ico_5_i(),ico_4_i(),ico_10_i()];
			return temp;
		}
