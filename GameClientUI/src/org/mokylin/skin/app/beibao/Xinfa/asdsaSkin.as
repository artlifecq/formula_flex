package org.mokylin.skin.app.beibao.Xinfa
{
	 ...
	 */
	public class asdsaSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function asdsaSkin()
		{
			super();
			
			this.currentState = "normal";
			this.elementsContent = [grp_icon_i(),grp_lab_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __asdsaSkin_UIAsset1_i():feathers.controls.UIAsset
		{
		...
		private function __asdsaSkin_UIAsset2_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.styleName = "ui/app/beibao/xinfa/yuan.png";
			temp.x = 56;
		...
		private function __asdsaSkin_UIAsset3_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.styleName = "ui/app/beibao/xinfa/yuan.png";
			temp.x = 39;
		...
		private function __asdsaSkin_UIAsset4_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.styleName = "ui/app/beibao/xinfa/yuan.png";
			temp.x = 0;
		...
		private function __asdsaSkin_UIAsset5_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.styleName = "ui/app/beibao/xinfa/yuan.png";
			temp.x = 39;
		...
		private function __asdsaSkin_UIAsset6_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.styleName = "ui/app/beibao/xinfa/yuan.png";
			temp.x = 123;
		...
		private function grp_icon_i():feathers.controls.Group
		{
			...
			temp.x = 0;
			temp.y = 0;
			temp.elementsContent = [ico_1_i(),ico_2_i(),ico_3_i(),ico_4_i(),ico_5_i(),__asdsaSkin_UIAsset1_i(),__asdsaSkin_UIAsset2_i(),__asdsaSkin_UIAsset3_i(),__asdsaSkin_UIAsset4_i(),__asdsaSkin_UIAsset5_i(),__asdsaSkin_UIAsset6_i()];
			return temp;
		}
