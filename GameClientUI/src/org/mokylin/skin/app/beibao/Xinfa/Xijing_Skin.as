package org.mokylin.skin.app.beibao.Xinfa
{
	 ...
	 */
	public class Xijing_Skin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		public var icd_12:feathers.controls.SkinnableContainer;

		public var icd_13:feathers.controls.SkinnableContainer;
		...
		private function grp_icondi_i():feathers.controls.Group
		{
			...
			temp.x = 0;
			temp.y = 0;
			temp.elementsContent = [icd_1_i(),icd_2_i(),icd_3_i(),icd_4_i(),icd_5_i(),icd_6_i(),icd_7_i(),icd_8_i(),icd_9_i(),icd_10_i(),icd_11_i(),icd_12_i(),icd_13_i()];
			return temp;
		}
		...
		private function icd_12_i():feathers.controls.SkinnableContainer
		{
			var temp:feathers.controls.SkinnableContainer = new feathers.controls.SkinnableContainer();
			icd_12 = temp;
			temp.name = "icd_12";
		...
		private function icd_13_i():feathers.controls.SkinnableContainer
		{
			var temp:feathers.controls.SkinnableContainer = new feathers.controls.SkinnableContainer();
			icd_13 = temp;
			temp.name = "icd_13";
