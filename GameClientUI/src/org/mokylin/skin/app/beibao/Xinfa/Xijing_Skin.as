package org.mokylin.skin.app.beibao.Xinfa
{
	...
	public class Xijing_Skin extends feathers.controls.StateSkin
	{
		...
		public var lab_13:feathers.controls.Label;
		...
		private function grp_lab_i():feathers.controls.Group
		{
			...
			temp.x = 106;
			temp.y = 75;
			temp.elementsContent = [lab_1_i(),lab_2_i(),lab_3_i(),lab_4_i(),lab_5_i(),lab_6_i(),lab_7_i(),lab_8_i(),lab_9_i(),lab_10_i(),lab_11_i(),lab_12_i(),lab_13_i()];
			return temp;
		}
		...
		private function lab_13_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			lab_13 = temp;
			temp.name = "lab_13";
