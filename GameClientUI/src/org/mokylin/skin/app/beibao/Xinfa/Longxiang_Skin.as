package org.mokylin.skin.app.beibao.Xinfa
{
	 ...
	 */
	public class Longxiang_Skin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function Longxiang_Skin()
		{
			super();
			
			this.currentState = "normal";
			this.elementsContent = [grp_icon_i(),grp_lab_i(),ico_xinfa_i()];
		...
		private function grp_icon_i():feathers.controls.Group
		{
			...
			temp.x = 103;
			temp.y = 43;
			temp.elementsContent = [ico_1_i(),ico_2_i(),ico_3_i(),ico_4_i(),ico_5_i(),ico_6_i(),ico_7_i(),ico_8_i(),ico_9_i(),ico_10_i()];
			return temp;
		}
		...
		private function grp_lab_i():feathers.controls.Group
		{
			...
			temp.x = 106;
			temp.y = 75;
			temp.elementsContent = [lab_1_i(),lab_2_i(),lab_3_i(),lab_4_i(),lab_5_i(),lab_6_i(),lab_7_i(),lab_8_i(),lab_9_i(),lab_10_i()];
			return temp;
		}
