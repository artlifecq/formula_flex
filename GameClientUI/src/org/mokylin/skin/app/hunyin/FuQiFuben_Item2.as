package org.mokylin.skin.app.hunyin
{
	 ...
	 */
	public class FuQiFuben_Item2 extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function FuQiFuben_Item2()
		{
			super();
			
			this.currentState = "normal";
			this.elementsContent = [__FuQiFuben_Item2_UIAsset1_i(),__FuQiFuben_Item2_UIAsset2_i(),__FuQiFuben_Item2_UIAsset3_i(),skinMc_i(),selectBg_i(),grpZhan_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __FuQiFuben_Item2_UIAsset1_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.styleName = "ui/app/hunyin/putong.png";
			temp.x = 0;
			temp.y = 0;
			return temp;
		}

		private function __FuQiFuben_Item2_UIAsset2_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.height = 38;
		...
		private function __FuQiFuben_Item2_UIAsset3_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.styleName = "ui/app/hunyin/60jikaiqi.png";
			temp.x = 66;
			temp.y = 242;
			return temp;
		}
