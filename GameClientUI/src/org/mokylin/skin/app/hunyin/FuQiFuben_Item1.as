package org.mokylin.skin.app.hunyin
{
	 ...
	 */
	public class FuQiFuben_Item1 extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function FuQiFuben_Item1()
		{
			super();
		...
		private function ui_lv_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			ui_lv = temp;
			temp.name = "ui_lv";
			temp.styleName = "ui/app/hunyin/10jikaiqi.png";
			temp.x = 66;
			temp.y = 242;
			return temp;
		}
