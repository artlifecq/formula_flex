package org.mokylin.skin.app.zuoqi
{
	...
	public class Zuoqi_JingjieOk_Skin extends feathers.controls.StateSkin
	{
		...
		public function Zuoqi_JingjieOk_Skin()
		{
			...
			this.height = 558;
			this.width = 1048;
			this.elementsContent = [bg_i(),uiGuangquan_i(),__Zuoqi_JingjieOk_Skin_UIAsset1_i(),mc_name_i(),mc_jieshu_i(),mc_zhanqiname_i(),btnOk_i(),ui_zhandouli_i(),userData_i(),num_lv_i(),ico_up_i(),uiName_i(),roleGrp_i()];
