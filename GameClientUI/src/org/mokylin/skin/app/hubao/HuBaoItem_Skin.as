package org.mokylin.skin.app.hubao
{
	 ...
	 */
	public class HuBaoItem_Skin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function HuBaoItem_Skin()
		{
			super();
			...
			this.height = 72;
			this.width = 139;
			this.elementsContent = [__HuBaoItem_Skin_UIAsset1_i(),__HuBaoItem_Skin_UIAsset2_i(),grpSelect_i(),icon1_i(),icon2_i(),lb1_i(),lb2_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __HuBaoItem_Skin_UIAsset1_i():feathers.controls.UIAsset
		{
		...
		private function __HuBaoItem_Skin_UIAsset2_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function __HuBaoItem_Skin_UIAsset3_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function __HuBaoItem_Skin_UIAsset4_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.scaleX = -1;
			temp.styleName = "ui/app/hubao/xuanzhongguangxiao.png";
		...
		private function grpSelect_i():feathers.controls.Group
		{
			...
			temp.x = 3;
			temp.y = 10;
			temp.elementsContent = [__HuBaoItem_Skin_UIAsset3_i(),__HuBaoItem_Skin_UIAsset4_i()];
			return temp;
		}
