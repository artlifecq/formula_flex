package org.mokylin.skin.app.zhanchang.wangchengzhengba
{
	...
	public class WangChengZhengBa extends feathers.controls.StateSkin
	{
		...
		public var cityImg:feathers.controls.UIAsset;
		...
		private function cityImg_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			cityImg = temp;
			temp.name = "cityImg";
		...
		private function grpCheng0_i():feathers.controls.Group
		{
			...
			temp.x = 402;
			temp.y = 363;
			temp.elementsContent = [cityImg_i(),uiBaoXiang_i(),uiLingQu_i()];
			return temp;
		}
