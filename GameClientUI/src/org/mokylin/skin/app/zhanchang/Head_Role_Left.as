package org.mokylin.skin.app.zhanchang
{
	 ...
	 */
	public class Head_Role_Left extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function Head_Role_Left()
		{
			super();
			...
			this.height = 91;
			this.width = 310;
			this.elementsContent = [__Head_Role_Left_UIAsset1_i(),role_xuecao_i(),__Head_Role_Left_UIAsset2_i(),lbName_i(),zhan_bg_i(),numZhandouli_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __Head_Role_Left_UIAsset1_i():feathers.controls.UIAsset
		{
