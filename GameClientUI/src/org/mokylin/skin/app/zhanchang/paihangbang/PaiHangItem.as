package org.mokylin.skin.app.zhanchang.paihangbang
{
	...
	import org.mokylin.skin.app.zhanchang.uinumber.UINumberNumpaihang;
	 ...
	 */
	public class PaiHangItem extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义成员方法
		//==========================================================================
		private function __PaiHangItem_UIAsset1_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.styleName = "ui/app/zhanchang/paihangbang/tiao2.png";
			temp.x = 0;
			temp.y = 0;
			return temp;
		}
		...
		private function num_i():feathers.controls.UINumber
		{
			...
			temp.height = 25;
			temp.label = "1";
			temp.styleClass = org.mokylin.skin.app.zhanchang.uinumber.UINumberNumpaihang;
			temp.width = 26;
			temp.x = 126;
			temp.y = 8;
			return temp;
		...
		private function uiTitle1_i():feathers.controls.UIAsset
		{
			...
			uiTitle1 = temp;
			temp.name = "uiTitle1";
			temp.styleName = "ui/app/zhanchang/paihangbang/di.png";
			temp.x = 105;
			temp.y = 7;
			return temp;
		}
		...
		private function uiTitle2_i():feathers.controls.UIAsset
		{
			...
			uiTitle2 = temp;
			temp.name = "uiTitle2";
			temp.styleName = "ui/app/zhanchang/paihangbang/ming.png";
			temp.x = 0;
			temp.y = 0;
			return temp;
		}
		...
		private function uiTitle3_i():feathers.controls.UIAsset
		{
			...
			uiTitle3 = temp;
			temp.name = "uiTitle3";
			temp.styleName = "ui/app/zhanchang/paihangbang/jiangli.png";
			temp.x = 22;
			temp.y = 0;
			return temp;
		}
