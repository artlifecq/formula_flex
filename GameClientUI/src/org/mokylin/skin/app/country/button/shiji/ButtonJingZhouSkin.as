package org.mokylin.skin.app.country.button.shiji
{
	 ...
	 */
	public class ButtonJingZhouSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function ButtonJingZhouSkin()
		{
			super();
		...
		private function hoverItem_i():feathers.controls.UIAsset
		{
			...
			temp.name = "hoverItem";
			temp.height = 22;
			temp.styleName = "ui/app/country/shiji/jingzhou/down.png";
			temp.width = 40;
			temp.x = 40;
			temp.y = 6;
			return temp;
		...
		private function normalItem_i():feathers.controls.UIAsset
		{
			...
			temp.height = 22;
			temp.styleName = "ui/app/country/shiji/jingzhou/up.png";
			temp.width = 40;
			temp.x = 40;
			temp.y = 6;
			return temp;
