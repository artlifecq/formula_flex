package org.mokylin.skin.app.country.society
{
	 ...
	 */
	public class SocietyListItemSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function SocietyListItemSkin()
		{
			super();
			...
			this.height = 32;
			this.width = 862;
			this.elementsContent = [itemBg_i(),itemSelected_i(),leaderName_i(),level_i(),onlineCount_i(),peopleCount_i(),societyName_i(),operateBtn_i()];
