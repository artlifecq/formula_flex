package org.mokylin.skin.app.paihangbang
{
	...
	public class PaiHang_Jieshu extends feathers.controls.StateSkin
	{
		...
		public function PaiHang_Jieshu()
		{
			...
			this.height = 522;
			this.width = 766;
			this.elementsContent = [skinRight_i(),btnAll_i(),skinFlip_i(),__PaiHang_Jieshu_Group1_i(),cellgroup_i(),__PaiHang_Jieshu_Group2_i(),uiTongjizhong_i()];
		...
		private function __PaiHang_Jieshu_Group2_i():feathers.controls.Group
		{
			...
			temp.x = 0;
			temp.y = 18;
			temp.elementsContent = [__PaiHang_Jieshu_UIAsset7_i(),__PaiHang_Jieshu_UIAsset8_i(),__PaiHang_Jieshu_UIAsset9_i(),__PaiHang_Jieshu_UIAsset10_i(),__PaiHang_Jieshu_UIAsset11_i(),__PaiHang_Jieshu_UIAsset12_i(),__PaiHang_Jieshu_UIAsset13_i(),__PaiHang_Jieshu_UIAsset14_i()];
			return temp;
		}
