package org.mokylin.skin.app.hongbao
{
	...
	public class HongBao_Chai extends feathers.controls.StateSkin
	{
		...
		public function HongBao_Chai()
		{
			...
			this.height = 502;
			this.width = 271;
			this.elementsContent = [__HongBao_Chai_UIAsset1_i(),uiLijing_i(),numL_i(),skinFlip_i(),btnEixt_i(),btnContinue_i(),itemgroup_i(),uiDown_i(),uiUp_i(),__HongBao_Chai_UIAsset2_i(),grpChai_i(),uiIcon_i(),btnClose_i()];
		...
		private function grpChai_i():feathers.controls.Group
		{
			...
			temp.x = 12;
			temp.y = 57;
			temp.elementsContent = [lbName_i(),btnChai_i(),grpMsg_i(),grpFa_i(),grpYiJian_i(),lbVip_i()];
			return temp;
		}
