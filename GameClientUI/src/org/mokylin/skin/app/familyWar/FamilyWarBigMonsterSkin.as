package org.mokylin.skin.app.familyWar
{
	 ...
	 */
	public class FamilyWarBigMonsterSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function FamilyWarBigMonsterSkin()
		{
			super();
		...
		private function thumb_i():feathers.controls.UIAsset
		{
			...
			thumb = temp;
			temp.name = "thumb";
			temp.styleName = "ui/app/familyWar/hong_56.png";
			temp.x = 0;
			temp.y = 0;
			return temp;
		}
		...
		private function track_i():feathers.controls.UIAsset
		{
			...
			temp.left = 0;
			temp.right = 0;
			temp.styleName = "ui/app/familyWar/lan_56.png";
			return temp;
		}
