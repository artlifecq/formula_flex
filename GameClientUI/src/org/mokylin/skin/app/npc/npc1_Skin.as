package org.mokylin.skin.app.npc
{
	 ...
	 */
	public class npc1_Skin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		public function npc1_Skin()
		{
			...
			this.height = 233;
			this.width = 694;
			this.elementsContent = [__npc1_Skin_UIAsset1_i(),btnClose_i(),btn_ok_i(),lbl_npcName_i(),lbl_details_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __npc1_Skin_UIAsset1_i():feathers.controls.UIAsset
		{
