package org.mokylin.skin.app.zhuangbei.hecheng
{
	 ...
	 */
	public class Cont_Item_qian extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function Cont_Item_qian()
		{
			super();
			...
			this.height = 32;
			this.width = 245;
			this.elementsContent = [__Cont_Item_qian_UIAsset1_i(),lb_Dispaly_i(),btn_over_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __Cont_Item_qian_UIAsset1_i():feathers.controls.UIAsset
		{
