package org.mokylin.skin.app.stall
{
	 ...
	 */
	public class StallTitle2Skin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function StallTitle2Skin()
		{
			super();
			
			this.currentState = "normal";
			this.elementsContent = [bg_i(),isSelect_i(),name_i(),left_i(),right_i()];
		...
		private function bg_i():feathers.controls.UIAsset
		{
			...
			temp.left = 0;
			temp.right = 0;
			temp.styleName = "ui/common/version_3/B_bujian/stall/dian_ji_2.png";
			temp.y = 0;
			return temp;
		}
		...
		private function isSelect_i():feathers.controls.UIAsset
		{
			...
			temp.left = 0;
			temp.right = 0;
			temp.styleName = "ui/common/version_3/B_bujian/stall/wei_dian_ji_2.png";
			temp.y = 0;
			return temp;
		}
		...
		private function left_i():feathers.controls.UIAsset
		{
			...
			temp.name = "left";
			temp.left = 21;
			temp.styleName = "ui/common/version_3/B_bujian/stall/yuan_bao.png";
			temp.y = 2;
			return temp;
		}
