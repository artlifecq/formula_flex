package org.mokylin.skin.app.stall
{
	 ...
	 */
	public class StallTitle1Skin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function StallTitle1Skin()
		{
			super();
		...
		private function bg_i():feathers.controls.UIAsset
		{
			...
			temp.left = 0;
			temp.right = 0;
			temp.styleName = "ui/common/version_3/B_bujian/stall/dian_ji_1.png";
			temp.y = 0;
			return temp;
		}
		...
		private function isSelect_i():feathers.controls.UIAsset
		{
			...
			temp.left = 0;
			temp.right = 0;
			temp.styleName = "ui/common/version_3/B_bujian/stall/wei_dian_ji_1.png";
			temp.y = 0;
			return temp;
		}
