package org.mokylin.skin.app.stall
{
	 ...
	 */
	public class SellGoodsToStallSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function SellGoodsToStallSkin()
		{
			super();
			
			this.currentState = "normal";
			this.elementsContent = [__SellGoodsToStallSkin_UIAsset1_i(),__SellGoodsToStallSkin_UIAsset2_i(),__SellGoodsToStallSkin_UIAsset3_i(),itemName_i(),btnClose_i(),__SellGoodsToStallSkin_Label1_i(),grid_i(),__SellGoodsToStallSkin_Label2_i(),__SellGoodsToStallSkin_Label3_i(),__SellGoodsToStallSkin_Label4_i(),__SellGoodsToStallSkin_Label5_i(),__SellGoodsToStallSkin_Label6_i(),sellGoodsTotal_i(),tax_i(),__SellGoodsToStallSkin_Label7_i(),sellGoodsPrice_i(),level_i(),sellGoods_i(),sellGoodsNum_i(),left_i(),right_i(),max_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __SellGoodsToStallSkin_Label1_i():feathers.controls.Label
		{
		...
		private function __SellGoodsToStallSkin_Label2_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			temp.fontSize = 14;
			temp.text = "出售数量:";
		...
		private function __SellGoodsToStallSkin_Label3_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			temp.fontSize = 14;
			temp.text = "出售单价:";
		...
		private function __SellGoodsToStallSkin_Label4_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			temp.fontSize = 14;
			temp.text = "（银两）";
		...
		private function __SellGoodsToStallSkin_Label5_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			temp.fontSize = 14;
			temp.text = "（银两）";
		...
		private function __SellGoodsToStallSkin_Label6_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			temp.fontSize = 14;
			temp.text = "出售总价:";
		...
		private function __SellGoodsToStallSkin_Label7_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			temp.fontSize = 14;
			temp.text = "税 收:";
		...
		private function __SellGoodsToStallSkin_UIAsset1_i():feathers.controls.UIAsset
		{
		...
		private function __SellGoodsToStallSkin_UIAsset2_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.height = 216;
		...
		private function __SellGoodsToStallSkin_UIAsset3_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.height = 69;
			temp.styleName = "ui/common/version_3/S_shurukuang/shu_ru_kuang_2.png";
