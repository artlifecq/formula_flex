package org.mokylin.skin.app.gmpanel
{
	...
	import org.mokylin.skin.component.combobox.ComboBoxSkin_1;
	...
	public class GmItemBoxSkin extends feathers.controls.StateSkin
	{
		...
		private function itemId_i():feathers.controls.ComboBox
		{
			...
			temp.name = "itemId";
			temp.height = 22;
			temp.styleClass = org.mokylin.skin.component.combobox.ComboBoxSkin_1;
			temp.color = 0xF9F0CC;
		...
		private function lbItemID_i():feathers.controls.TextInput
		{
			...
			lbItemID = temp;
			temp.name = "lbItemID";
			temp.styleClass = org.mokylin.skin.component.text.TextInput4Skin;
			temp.x = 9;
			temp.y = 69;
			return temp;
		}
