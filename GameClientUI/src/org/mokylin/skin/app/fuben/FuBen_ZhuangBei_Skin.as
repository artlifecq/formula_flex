package org.mokylin.skin.app.fuben
{
	...
	public class FuBen_ZhuangBei_Skin extends feathers.controls.StateSkin
	{
		...
		public function FuBen_ZhuangBei_Skin()
		{
			...
			this.height = 587;
			this.width = 947;
			this.elementsContent = [__FuBen_ZhuangBei_Skin_UIAsset1_i(),__FuBen_ZhuangBei_Skin_UIAsset2_i(),btnNext_i(),btnPrev_i(),__FuBen_ZhuangBei_Skin_UIAsset3_i(),ico_1_i(),ico_2_i(),ico_3_i(),ico_4_i(),ico_5_i(),ico_6_i(),lbShengyu_i(),lbGoumai_i(),btnAdd_i(),list_i()];
