package org.mokylin.skin.app.baZhenTu
{
	 ...
	 */
	public class BaZhenTuDungeonEndPanelItemrenderSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		public var killBossCount:feathers.controls.Label;
		...
		//                                定义构造函数
		//==========================================================================
		public function BaZhenTuDungeonEndPanelItemrenderSkin()
		{
			super();
			
			this.currentState = "normal";
			this.elementsContent = [itemBg_i(),nameTxt_i(),killCountTxt_i(),killEliteCountTxt_i(),killBossCount_i(),reliveCountTxt_i()];
		...
		private function killBossCount_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			killBossCount = temp;
			temp.name = "killBossCount";
			temp.bold = false;
			temp.height = 22;
			temp.fontSize = 14;
			temp.text = "99";
