package org.mokylin.skin.app.team.item
{
	 ...
	 */
	public class TeamNearbyPlayerSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		public var btnInvite:feathers.controls.Button;
		...
		//                                定义构造函数
		//==========================================================================
		public function TeamNearbyPlayerSkin()
		{
			super();
			...
			this.height = 425;
			this.width = 850;
			this.elementsContent = [group_i(),list_i(),btnRefresh_i(),btnInvite_i(),__TeamNearbyPlayerSkin_Label1_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __TeamNearbyPlayerSkin_Label1_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			temp.text = "左键双击即可邀请入队";
			temp.color = 0xCAAF94;
		...
		private function btnInvite_i():feathers.controls.Button
		{
