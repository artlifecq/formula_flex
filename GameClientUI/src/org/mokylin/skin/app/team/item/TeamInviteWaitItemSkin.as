package org.mokylin.skin.app.team.item
{
	 ...
	 */
	public class TeamInviteWaitItemSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		public var labMember:feathers.controls.Label;
		...
		//                                定义构造函数
		//==========================================================================
		public function TeamInviteWaitItemSkin()
		{
			super();
			
			this.currentState = "normal";
			this.width = 570;
			this.elementsContent = [itemBg_i(),itemSelected_i(),iconRace_i(),labPlayerName_i(),labLv_i(),labMember_i(),labFighting_i(),btnOK_i(),btnNO_i()];
		...
		private function labMember_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			labMember = temp;
			temp.name = "labMember";
