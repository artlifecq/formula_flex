package org.mokylin.skin.app.banghui.huangcheng
{
	 ...
	 */
	public class Head_Info extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		public var skin3:feathers.controls.SkinnableContainer;
		...
		public function Head_Info()
		{
			...
			this.height = 30;
			this.width = 162;
			this.elementsContent = [__Head_Info_UIAsset1_i(),skin1_i(),skin2_i(),skin3_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __Head_Info_UIAsset1_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.styleName = "ui/common/bgdi.png";
			temp.width = 162;
			temp.x = 0;
			temp.y = 0;
			return temp;
		...
		private function skin3_i():feathers.controls.SkinnableContainer
		{
			var temp:feathers.controls.SkinnableContainer = new feathers.controls.SkinnableContainer();
			skin3 = temp;
			temp.name = "skin3";
