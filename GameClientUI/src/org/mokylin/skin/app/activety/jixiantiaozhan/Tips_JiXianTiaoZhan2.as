package org.mokylin.skin.app.activety.jixiantiaozhan
{
	 ...
	 */
	public class Tips_JiXianTiaoZhan2 extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function Tips_JiXianTiaoZhan2()
		{
			super();
			
			this.currentState = "normal";
			this.width = 280;
			this.elementsContent = [bg_i(),line1_i(),line2_i(),lbT1_i(),lbT2_i(),lbT4_i(),lbT3_i(),__Tips_JiXianTiaoZhan2_Label4_i(),icon_i(),lbName_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __Tips_JiXianTiaoZhan2_Label4_i():feathers.controls.Label
		{
		...
		private function lbT3_i():feathers.controls.Label
		{
			...
			temp.leading = 1;
			temp.letterSpacing = 0;
			temp.text = "提示：离开地图后，BUFF效果立即消失，仅在本次活动期间的活动地图生效。";
			temp.color = 0xEAEABC;
			temp.nativeFilters = Fontter.filterObj["textFilterBlackGreen"];
			temp.width = 256;
			temp.x = 11;
