package org.mokylin.skin.app.showgirl
{
	...
	public class ShowGirl_Skin extends feathers.controls.StateSkin
	{
		...
		public function ShowGirl_Skin()
		{
			...
			this.height = 601;
			this.width = 956;
			this.elementsContent = [bg_i(),__ShowGirl_Skin_UIAsset1_i(),__ShowGirl_Skin_UIAsset2_i(),imgGirl_i(),__ShowGirl_Skin_UIAsset3_i()];
		...
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.styleName = "ui/app/showgirl/bg.jpg";
			temp.x = 23;
			temp.y = 87;
			return temp;
		}
