package org.mokylin.skin.app.toujing.trackItem
{
	...
	public class TouJingEventTrackSkin extends feathers.controls.StateSkin
	{
		...
		public var labCD:feathers.controls.Label;
		...
		public function TouJingEventTrackSkin()
		{
			...
			this.height = 205;
			this.width = 230;
			this.elementsContent = [img1_i(),labDesc_i(),list_i(),labCountDown_i(),labBelongsCountry_i(),labJingShuQuality_i(),labCD_i(),hpDi_i(),imgBar_i(),labRate_i(),btnReturn_i(),labJingShuState_i(),labCountryName_i(),labTittle_i(),labMyCountry_i()];
		...
		private function labCD_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			labCD = temp;
			temp.name = "labCD";
