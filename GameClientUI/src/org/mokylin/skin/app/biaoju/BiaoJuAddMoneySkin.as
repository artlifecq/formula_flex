package org.mokylin.skin.app.biaoju
{
	 ...
	 */
	public class BiaoJuAddMoneySkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function BiaoJuAddMoneySkin()
		{
			super();
			
			this.currentState = "normal";
			this.elementsContent = [__BiaoJuAddMoneySkin_UIAsset1_i(),__BiaoJuAddMoneySkin_UIAsset2_i(),__BiaoJuAddMoneySkin_UIAsset3_i(),__BiaoJuAddMoneySkin_Label1_i(),__BiaoJuAddMoneySkin_Label2_i(),__BiaoJuAddMoneySkin_UIAsset4_i(),closeBtn_i(),title_i(),btn_i(),juankuanLbl_i(),group_i(),des_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __BiaoJuAddMoneySkin_HorizontalLayout1_i():feathers.layout.HorizontalLayout
		{
		...
		private function __BiaoJuAddMoneySkin_Label1_i():feathers.controls.Label
		{
		...
		private function __BiaoJuAddMoneySkin_Label2_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			temp.bold = false;
			temp.height = 20;
		...
		private function __BiaoJuAddMoneySkin_UIAsset1_i():feathers.controls.UIAsset
		{
		...
		private function __BiaoJuAddMoneySkin_UIAsset2_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.height = 152;
		...
		private function __BiaoJuAddMoneySkin_UIAsset3_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.height = 105;
		...
		private function __BiaoJuAddMoneySkin_UIAsset4_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function group_i():feathers.controls.Group
		{
			...
			temp.x = 57;
			temp.y = 123;
			temp.layout = __BiaoJuAddMoneySkin_HorizontalLayout1_i();
