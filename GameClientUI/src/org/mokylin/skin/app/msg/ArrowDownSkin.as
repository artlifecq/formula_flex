package org.mokylin.skin.app.msg
{
	 ...
	 */
	public class ArrowDownSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义成员方法
		//==========================================================================
		private function __ArrowDownSkin_UIAsset1_i():feathers.controls.UIAsset
		{
		...
		private function gText_i():feathers.controls.Group
		{
			...
			temp.x = -99;
			temp.y = -115;
			temp.elementsContent = [__ArrowDownSkin_UIAsset1_i(),line_i(),lbName_i()];
			return temp;
		}
