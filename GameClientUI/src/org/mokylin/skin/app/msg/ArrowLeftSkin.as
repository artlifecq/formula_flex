package org.mokylin.skin.app.msg
{
	 ...
	 */
	public class ArrowLeftSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义成员方法
		//==========================================================================
		private function __ArrowLeftSkin_UIAsset1_i():feathers.controls.UIAsset
		{
		...
		private function gText_i():feathers.controls.Group
		{
			...
			temp.x = 43;
			temp.y = -32;
			temp.elementsContent = [__ArrowLeftSkin_UIAsset1_i(),line_i(),lbName_i()];
			return temp;
		}
