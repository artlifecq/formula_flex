package org.mokylin.skin.app.msg
{
	 ...
	 */
	public class ArrowUpSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义成员方法
		//==========================================================================
		private function __ArrowUpSkin_UIAsset1_i():feathers.controls.UIAsset
		{
		...
		private function gText_i():feathers.controls.Group
		{
			...
			temp.x = -100;
			temp.y = 43;
			temp.elementsContent = [__ArrowUpSkin_UIAsset1_i(),line_i(),lbName_i()];
			return temp;
		}
