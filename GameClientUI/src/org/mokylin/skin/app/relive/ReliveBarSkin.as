package org.mokylin.skin.app.relive
{
	 ...
	 */
	public class ReliveBarSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		private function thumb_i():feathers.controls.UIAsset
		{
			...
			temp.name = "thumb";
			temp.height = 11;
			temp.styleName = "ui/common/bar/xue_tiao.png";
			temp.width = 245;
			temp.x = 14;
			temp.y = 7;
			return temp;
		...
		private function track_i():feathers.controls.UIAsset
		{
			...
			temp.left = 0;
			temp.right = 0;
			temp.styleName = "ui/common/bar/di.png";
			return temp;
		}
