package org.mokylin.skin.component.button
{
	 ...
	 */
	public class ButtonSkin_anniu4 extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function ButtonSkin_anniu4()
		{
			super();
			...
			skinNames={"disabled":"ui/component/button/skin_anniu4/disabled.png",
			"down":"ui/component/button/skin_anniu4/down.png",
			"hover":"ui/component/button/skin_anniu4/over.png",
			"up":"ui/component/button/skin_anniu4/up.png"};
		}
