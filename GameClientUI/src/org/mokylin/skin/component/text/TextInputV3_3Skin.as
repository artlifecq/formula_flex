package org.mokylin.skin.component.text
{
	 ...
	 */
	public class TextInputV3_3Skin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function TextInputV3_3Skin()
		{
			super();
			...
			skinNames={"disabled":"ui/common/kang/di.png", "enabled":"ui/common/kang/di.png", "focused":"ui/common/kang/di.png"};
		}
		...
		private function bg_i():feathers.controls.UIAsset
		{
			...
			temp.left = 0;
			temp.right = 0;
			temp.styleName = "ui/common/kang/di.png";
			temp.top = 0;
			return temp;
		}
