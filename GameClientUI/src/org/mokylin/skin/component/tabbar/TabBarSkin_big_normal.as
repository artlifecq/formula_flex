package org.mokylin.skin.component.tabbar
{
	 ...
	 */
	public class TabBarSkin_big_normal extends feathers.controls.StateSkin
	{
		...
		//                                定义构造函数
		//==========================================================================
		public function TabBarSkin_big_normal()
		{
			super();
			...
			skinNames={"hover":"ui/component/tabbar/skin_big_normal/over.png",
