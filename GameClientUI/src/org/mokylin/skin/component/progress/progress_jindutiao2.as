package org.mokylin.skin.component.progress
{
	 ...
	 */
	public class progress_jindutiao2 extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function progress_jindutiao2()
		{
			super();
		...
		private function thumb_i():feathers.controls.UIAsset
		{
			...
			thumb = temp;
			temp.name = "thumb";
			temp.styleName = "ui/component/progress/jindutiao2/tiao1.png";
			temp.x = 0;
			temp.y = 0;
			return temp;
		}
