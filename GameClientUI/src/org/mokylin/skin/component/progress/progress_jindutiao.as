package org.mokylin.skin.component.progress
{
	 ...
	 */
	public class progress_jindutiao extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function progress_jindutiao()
		{
			super();
		...
		private function thumb_i():feathers.controls.UIAsset
		{
			...
			temp.left = 0;
			temp.right = 0;
			temp.styleName = "ui/component/progress/jindutiao/jdt.png";
			temp.y = 0;
			return temp;
		}
