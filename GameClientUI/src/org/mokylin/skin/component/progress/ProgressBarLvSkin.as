package org.mokylin.skin.component.progress
{
	 ...
	 */
	public class ProgressBarLvSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function ProgressBarLvSkin()
		{
			super();
		...
		private function thumb_i():feathers.controls.UIAsset
		{
			...
			temp.left = 8;
			temp.right = 8;
			temp.styleName = "ui/common/version_3/J_jindutiao/jin_du_tiao.jpg";
			temp.y = 3;
			return temp;
		}
