package org.mokylin.skin.component.progress
{
	 ...
	 */
	public class progress_jindutiao4 extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function progress_jindutiao4()
		{
			super();
		...
		private function thumb_i():feathers.controls.UIAsset
		{
			...
			temp.left = 0;
			temp.right = 0;
			temp.styleName = "ui/component/progress/jindutiao4/jut_tiao.png";
			temp.y = 0;
			return temp;
		}
