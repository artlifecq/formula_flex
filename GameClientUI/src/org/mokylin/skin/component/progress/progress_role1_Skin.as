package org.mokylin.skin.component.progress
{
	 ...
	 */
	public class progress_role1_Skin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function progress_role1_Skin()
		{
			super();
		...
		private function thumb_i():feathers.controls.UIAsset
		{
			...
			thumb = temp;
			temp.name = "thumb";
			temp.styleName = "ui/component/progress/skin_role1/thumb.png";
			temp.x = 0;
			temp.y = 0;
			return temp;
		}
		...
		private function track_i():feathers.controls.UIAsset
		{
			...
			track = temp;
			temp.name = "track";
			temp.styleName = "ui/component/progress/skin_role1/track.png";
			temp.x = 0;
			temp.y = 0;
			return temp;
		}
