package org.mokylin.skin.component.progress
{
	 ...
	 */
	public class pro_renwu extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		private function thumb_i():feathers.controls.UIAsset
		{
			...
			thumb = temp;
			temp.name = "thumb";
			temp.styleName = "ui/component/progress/skin_renwu/track.png";
			temp.x = 0;
			temp.y = 0;
			return temp;
		}
		...
		private function track_i():feathers.controls.UIAsset
		{
			...
			track = temp;
			temp.name = "track";
			temp.styleName = "ui/component/progress/skin_renwu/thumb.png";
			temp.x = 0;
			temp.y = 0;
			return temp;
		}
