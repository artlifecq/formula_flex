package org.mokylin.skin.component.scrollbar.skin_equip.button
{
	...
	public class ScrollBarSkin_decre extends feathers.controls.StateSkin
	{
		...
		public var __ScrollBarSkin_decre_UIAsset4:feathers.controls.UIAsset;
		...
		public function ScrollBarSkin_decre()
		{
			...
			__ScrollBarSkin_decre_UIAsset4_i();
			
			
			states = {
			};
			skinNames={"disabled":"ui/component/scrollbar/skin_equip/button/skin_decre/disabled.png",
			"down":"ui/component/scrollbar/skin_equip/button/skin_decre/down.png",
			"hover":"ui/component/scrollbar/skin_equip/button/skin_decre/over.png",
			"up":"ui/component/scrollbar/skin_equip/button/skin_decre/up.png"};
		}
		...
		private function __ScrollBarSkin_decre_UIAsset1_i():feathers.controls.UIAsset
		{
			...
			temp.styleName = "ui/component/scrollbar/skin_equip/button/skin_decre/disabled.png";
			return temp;
		}
		...
		private function __ScrollBarSkin_decre_UIAsset2_i():feathers.controls.UIAsset
		{
			...
			temp.styleName = "ui/component/scrollbar/skin_equip/button/skin_decre/down.png";
			return temp;
		}
		...
		private function __ScrollBarSkin_decre_UIAsset3_i():feathers.controls.UIAsset
		{
			...
			temp.styleName = "ui/component/scrollbar/skin_equip/button/skin_decre/over.png";
			return temp;
		}

		private function __ScrollBarSkin_decre_UIAsset4_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			__ScrollBarSkin_decre_UIAsset4 = temp;
			temp.styleName = "ui/component/scrollbar/skin_equip/button/skin_decre/up.png";
			return temp;
		}
