package org.mokylin.skin.component.scrollbar.skin_lv.button
{
	...
	public class ScrollBarSkin_decre extends feathers.controls.StateSkin
	{
		...
		public function ScrollBarSkin_decre()
		{
			...
			skinNames={"down":"ui/component/scrollbar/skin_lv/button/skin_decre/down.png", "hover":"ui/component/scrollbar/skin_lv/button/skin_decre/over.png", "up":"ui/component/scrollbar/skin_lv/button/skin_decre/up.png"};
		}
		...
		private function __ScrollBarSkin_decre_UIAsset1_i():feathers.controls.UIAsset
		{
			...
			temp.styleName = "ui/component/scrollbar/skin_lv/button/skin_decre/down.png";
			temp.top = 0;
			return temp;
		}
		...
		private function __ScrollBarSkin_decre_UIAsset2_i():feathers.controls.UIAsset
		{
			...
			temp.styleName = "ui/component/scrollbar/skin_lv/button/skin_decre/over.png";
			temp.top = 0;
			return temp;
		}
		...
		private function __ScrollBarSkin_decre_UIAsset3_i():feathers.controls.UIAsset
		{
			...
			temp.styleName = "ui/component/scrollbar/skin_lv/button/skin_decre/up.png";
			temp.top = 0;
			return temp;
		}
