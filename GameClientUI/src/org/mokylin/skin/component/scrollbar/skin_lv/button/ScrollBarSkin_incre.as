package org.mokylin.skin.component.scrollbar.skin_lv.button
{
	...
	public class ScrollBarSkin_incre extends feathers.controls.StateSkin
	{
		...
		public function ScrollBarSkin_incre()
		{
			...
			skinNames={"down":"ui/component/scrollbar/skin_lv/button/skin_incre/down.png", "hover":"ui/component/scrollbar/skin_lv/button/skin_incre/over.png", "up":"ui/component/scrollbar/skin_lv/button/skin_incre/up.png"};
		}
		...
		private function __ScrollBarSkin_incre_UIAsset1_i():feathers.controls.UIAsset
		{
			...
			temp.bottom = 0;
			temp.styleName = "ui/component/scrollbar/skin_lv/button/skin_incre/down.png";
			return temp;
		}
		...
		private function __ScrollBarSkin_incre_UIAsset2_i():feathers.controls.UIAsset
		{
			...
			temp.bottom = 0;
			temp.styleName = "ui/component/scrollbar/skin_lv/button/skin_incre/over.png";
			return temp;
		}
		...
		private function __ScrollBarSkin_incre_UIAsset3_i():feathers.controls.UIAsset
		{
			...
			temp.bottom = 0;
			temp.styleName = "ui/component/scrollbar/skin_lv/button/skin_incre/up.png";
			return temp;
		}
