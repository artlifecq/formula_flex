package org.mokylin.skin.common.alert
{
	 ...
	 */
	public class AlertPiLiangShiYong extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function AlertPiLiangShiYong()
		{
			super();
			
			this.currentState = "normal";
			this.elementsContent = [bg_i(),__AlertPiLiangShiYong_UIAsset1_i(),__AlertPiLiangShiYong_UIAsset2_i(),btnClose_i(),btn_ok_i(),btns_i(),contents_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __AlertPiLiangShiYong_Label1_i():feathers.controls.Label
		{
		...
		private function __AlertPiLiangShiYong_UIAsset1_i():feathers.controls.UIAsset
		{
		...
		private function __AlertPiLiangShiYong_UIAsset2_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function btns_i():feathers.controls.Group
		{
			...
			temp.x = 42;
			temp.y = 162;
			temp.elementsContent = [__AlertPiLiangShiYong_Label1_i(),btn_min_i(),btn_max_i(),btn_all_i(),bg0_i(),lbBuyNum_i()];
			return temp;
		}
