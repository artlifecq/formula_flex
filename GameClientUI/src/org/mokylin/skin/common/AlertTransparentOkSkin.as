package org.mokylin.skin.common
{
	 ...
	 */
	public class AlertTransparentOkSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function AlertTransparentOkSkin()
		{
			super();
			
			this.currentState = "normal";
			this.elementsContent = [__AlertTransparentOkSkin_UIAsset1_i(),btnClose_i(),cboxTip_i(),lbTip_i(),btnOk_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __AlertTransparentOkSkin_UIAsset1_i():feathers.controls.UIAsset
		{
