package org.mokylin.skin.mainui.tishi
{
	 ...
	 */
	public class Sing_TipsSkin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		public var bar_scroll:feathers.controls.UIAsset;
		...
		public function Sing_TipsSkin()
		{
			...
			this.height = 49;
			this.width = 257;
			this.elementsContent = [__Sing_TipsSkin_UIAsset1_i(),bar_scroll_i(),bar_bg_i(),bar_i(),lbl_progress_i(),lbl_title_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __Sing_TipsSkin_UIAsset1_i():feathers.controls.UIAsset
		{
		...
		private function bar_scroll_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			bar_scroll = temp;
			temp.name = "bar_scroll";
