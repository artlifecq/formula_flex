package org.mokylin.skin.mainui.chat
{
	 ...
	 */
	public class chat2_Skin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		public function chat2_Skin()
		{
			...
			this.height = 335;
			this.width = 364;
			this.elementsContent = [grp_txt_i(),btn_lock_i(),grp_buttom_i(),lb_tishi_i(),grp_laba_i(),grp_select_i(),tab_Type_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __chat2_Skin_ArrayCollection1_i():feathers.data.ListCollection
		{
		...
		private function __chat2_Skin_HorizontalLayout1_i():feathers.layout.HorizontalLayout
		{
		...
		private function __chat2_Skin_UIAsset2_i():feathers.controls.UIAsset
		{
		...
		private function __chat2_Skin_UIAsset3_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function grp_laba_i():feathers.controls.Group
		{
			...
			temp.x = 2;
			temp.y = 0;
			temp.elementsContent = [__chat2_Skin_UIAsset2_i(),__chat2_Skin_UIAsset3_i()];
			return temp;
		}
		...
		private function tab_Type_i():feathers.controls.TabBar
		{
			...
			temp.x = 2;
			temp.y = 52;
			temp.layout = __chat2_Skin_HorizontalLayout1_i();
			temp.dataProvider = __chat2_Skin_ArrayCollection1_i();
			return temp;
		}
