package org.mokylin.skin.mainui.shortcut
{
	...
	import org.mokylin.skin.common.version_3.T_tubiao.T_tishitubiao.button.ButtonFu_huo;
	...
	public class MessageReliveIconSkin extends feathers.controls.StateSkin
	{
		...
		private function btn_i():feathers.controls.Button
		{
			...
			btn = temp;
			temp.name = "btn";
			temp.styleClass = org.mokylin.skin.common.version_3.T_tubiao.T_tishitubiao.button.ButtonFu_huo;
			temp.x = 7;
			temp.y = 7;
			return temp;
		}
