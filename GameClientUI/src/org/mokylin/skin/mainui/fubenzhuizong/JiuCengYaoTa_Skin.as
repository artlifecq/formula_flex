package org.mokylin.skin.mainui.fubenzhuizong
{
	...
	public class JiuCengYaoTa_Skin extends feathers.controls.StateSkin
	{
		...
		public var lbShouwei:feathers.controls.Label;
		...
		private function __JiuCengYaoTa_Skin_Label2_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			temp.fontSize = 14;
			temp.text = "【进入下一层条件】";
		...
		private function __JiuCengYaoTa_Skin_Label3_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			temp.fontSize = 14;
			temp.text = "【升层奖励】";
		...
		private function __JiuCengYaoTa_Skin_Label4_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			temp.fontSize = 14;
			temp.text = "积分条件：";
		...
		private function __JiuCengYaoTa_Skin_Label5_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			temp.fontSize = 14;
			temp.text = "我的战场积分：";
		...
		private function __JiuCengYaoTa_Skin_UIAsset1_i():feathers.controls.UIAsset
		{
		...
		private function lbShouwei_i():feathers.controls.Label
		{
			var temp:feathers.controls.Label = new feathers.controls.Label();
			lbShouwei = temp;
			temp.name = "lbShouwei";
		...
		private function scroll_box_i():feathers.controls.Group
		{
			...
			temp.x = 12;
			temp.y = 37;
			temp.elementsContent = [__JiuCengYaoTa_Skin_Label1_i(),__JiuCengYaoTa_Skin_Label2_i(),__JiuCengYaoTa_Skin_Label3_i(),__JiuCengYaoTa_Skin_Label4_i(),__JiuCengYaoTa_Skin_Label5_i(),lbMyNum_i(),__JiuCengYaoTa_Skin_UIAsset5_i(),pro_bar_i(),lbNum_i(),sec_time_i(),lbShouwei_i(),lbPaihang_i(),sec_ico1_0_i(),sec_ico1_1_i(),sec_ico1_2_i(),sec_ico1_3_i(),sec_subbut1_i()];
			return temp;
		}
		...
		private function secondary_box_i():feathers.controls.Group
		{
			...
			temp.x = 0;
			temp.y = 0;
			temp.elementsContent = [lbHeadName_i(),__JiuCengYaoTa_Skin_UIAsset3_i(),__JiuCengYaoTa_Skin_UIAsset4_i(),scroll_box_i()];
			return temp;
		}
		...
		private function task_box_i():feathers.controls.Group
		{
			...
			temp.x = 0;
			temp.y = 0;
			temp.elementsContent = [__JiuCengYaoTa_Skin_UIAsset1_i(),__JiuCengYaoTa_Skin_UIAsset2_i(),secondary_box_i()];
			return temp;
		}
