package org.mokylin.skin.mainui.fubenzhuizong
{
	...
	public class JiuCengYaoTaTrack_Skin extends feathers.controls.StateSkin
	{
		...
		private function gFlag_i():feathers.controls.Group
		{
			...
			temp.x = 85;
			temp.y = -41;
			temp.elementsContent = [__JiuCengYaoTaTrack_Skin_UIAsset4_i(),labOwner_i(),labOwnerTime_i()];
			return temp;
		}
		...
		private function gLevel_i():feathers.controls.Group
		{
			...
			temp.x = 10;
			temp.y = 42;
			temp.elementsContent = [labContent_i(),__JiuCengYaoTaTrack_Skin_Label3_i(),__JiuCengYaoTaTrack_Skin_UIAsset3_i(),pro_bar_i(),lbNum_i()];
			return temp;
		}
