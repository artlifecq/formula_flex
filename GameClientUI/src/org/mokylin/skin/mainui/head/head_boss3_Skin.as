package org.mokylin.skin.mainui.head
{
	 ...
	 */
	public class head_boss3_Skin extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		//                                定义构造函数
		//==========================================================================
		public function head_boss3_Skin()
		{
			super();
			...
			this.height = 92;
			this.width = 430;
			this.elementsContent = [__head_boss3_Skin_UIAsset1_i(),grp_xueyiao_i(),lbl_name_i(),grp_buff_i(),uim_xuetiao_i(),__head_boss3_Skin_UIAsset2_i(),uim_zhandouli_i()];
		...
		//                                定义成员方法
		//==========================================================================
		private function __head_boss3_Skin_HorizontalLayout1_i():feathers.layout.HorizontalLayout
		{
		...
		private function __head_boss3_Skin_UIAsset1_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
			temp.styleName = "ui/mainui/head/3_sanji.png";
			temp.x = 0;
			temp.y = 13;
			return temp;
		}

		private function __head_boss3_Skin_UIAsset2_i():feathers.controls.UIAsset
		{
			var temp:feathers.controls.UIAsset = new feathers.controls.UIAsset();
		...
		private function uim_xuetiao_i():feathers.controls.UINumber
		{
			...
			temp.x = 356;
			temp.y = 9;
			temp.layout = __head_boss3_Skin_HorizontalLayout1_i();
			return temp;
		}
