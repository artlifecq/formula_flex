package org.mokylin.skin.mainui.message
{
	...
	import org.mokylin.skin.mainui.message.button.ButtonDuiwu;
	 ...
	 */
	public class Msg_Duiwu extends feathers.controls.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		private function btnCont_i():feathers.controls.Button
		{
			...
			btnCont = temp;
			temp.name = "btnCont";
			temp.styleClass = org.mokylin.skin.mainui.message.button.ButtonDuiwu;
			temp.x = 0;
			temp.y = 0;
			return temp;
		}
