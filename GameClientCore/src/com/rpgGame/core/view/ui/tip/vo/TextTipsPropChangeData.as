package com.rpgGame.core.view.ui.tip.vo
{
	 ...
	 *
	 */
	public class TextTipsPropChangeData extends EventDispatcher
	{
		private var _info : String;
		private var _dynamicData : Array;
		private var _dynamicFun : Function;
		public static const TEXTTIPCHANGE:String = "TextTipChange";
		/**
		 * 文本TIPS的数据
		 ...
		 *
		 */
		public function TextTipsPropChangeData(info : String, dynamicData : Array = null, dynamicFunc : Function = null)
		{
			this.info = info;
		...
		public function refeashValue():void
		{
			this.dispatchEventWith(TEXTTIPCHANGE);
		}
	}
}
