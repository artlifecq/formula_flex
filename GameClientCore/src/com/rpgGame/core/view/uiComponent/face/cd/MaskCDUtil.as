package com.rpgGame.core.view.uiComponent.face.cd
{
	...
	public class MaskCDUtil
	{
		...
		private static var _assets:Object = new Object();
		public static function getAssetTexture(key:String):BitmapFontTexture
		{
			return _assets[key] as BitmapFontTexture;
		}
		
		public static function addBitmapFontTexture(key:String, texture:BitmapFontTexture):void
		{
			_assets[key] = texture;
		}
