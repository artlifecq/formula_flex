...
//			,AppConstant.WU_XING_SUI_PIAN_EXCHANGE_PANEL]
//		_configDic[AppConstant.STORE_PANEL] = [AppConstant.STORE_PANEL,AppConstant.MOUNT_UPGRADE_PANEL];
		_configDic[AppConstant.MAIL_PANEL] = [AppConstant.MAIL_PANEL];
		_configDic[AppConstant.ROLE_PANEL] = [AppConstant.ROLE_PANEL, AppConstant.SHOP_PANEL,AppConstant.STORAGE_PANEL];
		_configDic[AppConstant.STORAGE_PANEL] = [AppConstant.ROLE_PANEL,,AppConstant.STORAGE_PANEL];
		_configDic[AppConstant.SHOP_PANEL] = [AppConstant.ROLE_PANEL, AppConstant.SHOP_PANEL];
		_configDic[AppConstant.STALL_PANEL] = [AppConstant.STALL_SELL_PANEL,AppConstant.STALL_BUY_PANEL,AppConstant.STALL_BUY_GOODS_FROM_STALL,AppConstant.STALL_SELL_GOODS_TO_STALL];
		_configDic[AppConstant.STALL_SELL_PANEL] = [AppConstant.STALL_PANEL];
		_configDic[AppConstant.STALL_BUY_PANEL] = [AppConstant.STALL_PANEL];
		_configDic[AppConstant.STALL_BUY_GOODS_FROM_STALL] = [AppConstant.STALL_PANEL];
		_configDic[AppConstant.STALL_SELL_GOODS_TO_STALL] = [AppConstant.STALL_PANEL];
		
//		_configDic[AppConstant.ROLE_UP_PANEL] = [AppConstant.C_ROLE_PANEL,AppConstant.ROLE_UP_PANEL];
//		_configDic[AppConstant.SMALL_SHOP_PANEL] = [AppConstant.SMALL_SHOP_PANEL];
...
//		_configDic[AppConstant.WU_XING_SUI_PIAN_EXCHANGE_PANEL] = [AppConstant.WU_XING_SUI_PIAN_EXCHANGE_PANEL];
//		_configDic[AppConstant.TRADE_PANEL] = [AppConstant.TRADE_PANEL];
//		_configDic[AppConstant.STALL_PANEL] = [AppConstant.STALL_PANEL];		
		
		private static var _mutexDic:Dictionary = new Dictionary();//互斥面板；
		_mutexDic[AppConstant.GM_PANEL] = [AppConstant.ROLE_PANEL];
