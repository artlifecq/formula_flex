package org.mokylin.skin.loading.alert.button
{
	...
	public class ButtonSkin_getequip extends feathers.controls.StateSkin
	{
		...
		public function ButtonSkin_getequip()
		{
			...
			skinNames={"disabled":"ui/loading/alert/button/skin_getequip/disabled.png",
			"down":"ui/loading/alert/button/skin_getequip/down.png",
			"hover":"ui/loading/alert/button/skin_getequip/over.png",
			"up":"ui/loading/alert/button/skin_getequip/up.png"};
		}
