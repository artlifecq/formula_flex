package com.rpgGame.appModule.open
{
	...
	public class NoticeOpenState extends SkinUI
	{
		...
		public function refeashView(data:Q_newfunc):void
		{
			...
			_skin.Icons.styleName = "ui/app/xingongneng/icon/"+data.q_res_dir+"/95.png";
			_skin.uiName.styleName = "ui/app/xingongneng/icon/"+data.q_res_dir+"/name1.png";
			...
			if(!data.q_res_dir)
				...
				_skin.uiTouxian.styleName = "ui/app/xingongneng/icon/"+data.q_res_dir+"/word.png";
			}
		}
