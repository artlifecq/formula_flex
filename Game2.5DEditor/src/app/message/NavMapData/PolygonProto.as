package app.message.NavMapData {
	...
	public dynamic final class PolygonProto extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const POINT:RepeatedFieldDescriptor_TYPE_INT32 = new RepeatedFieldDescriptor_TYPE_INT32("app.message.NavMapData.PolygonProto.point", "point", (1 << 3) | com.netease.protobuf.WireType.VARINT);
