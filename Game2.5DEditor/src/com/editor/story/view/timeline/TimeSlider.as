package com.editor.story.view.timeline
{
	...
	public class TimeSlider extends UIComponent
	{
		...
		private static const DEFAULT_DURATION:uint = 100000;
		...
		override protected function createChildren():void
		{
			...
			thumb.width = 20;
			thumb.height = 20;
			thumb.styleName = "timeSliderThumb";
...
//			this.addChild(endValueTxt);
		...
		public function set duration(value:uint):void
		{
			_duration = value;
			startTime = 0;
			endTime = Math.min(DEFAULT_DURATION,_duration);
			_propChanged = true;
		...
		public function set endTime(value:int):void
		{
			_endTime = value;
			if(_endTime < 0)
				_endTime = Math.min(DEFAULT_DURATION,_duration);
			_propChanged = true;
			invalidateProperties();
		}
