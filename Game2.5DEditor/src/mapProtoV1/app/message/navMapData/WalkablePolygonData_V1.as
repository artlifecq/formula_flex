package mapProtoV1.app.message.navMapData {
	...
	public dynamic final class WalkablePolygonData_V1 extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const IS_WALKABLE:FieldDescriptor_TYPE_BOOL = new FieldDescriptor_TYPE_BOOL("mapProtoV1.app.message.navMapData.WalkablePolygonData.is_walkable", "isWalkable", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const POINT:RepeatedFieldDescriptor_TYPE_INT32 = new RepeatedFieldDescriptor_TYPE_INT32("mapProtoV1.app.message.navMapData.WalkablePolygonData.point", "point", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SUB_POLY:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("mapProtoV1.app.message.navMapData.WalkablePolygonData.sub_poly", "subPoly", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return WalkablePolygonData_V1; });
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					...
					break;
				case 3:
					this.subPoly.push(com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, new WalkablePolygonData_V1()));
					break;
				default:
