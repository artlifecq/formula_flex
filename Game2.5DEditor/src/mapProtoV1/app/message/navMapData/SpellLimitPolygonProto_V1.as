package mapProtoV1.app.message.navMapData {
	...
	public dynamic final class SpellLimitPolygonProto_V1 extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const POLY:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("mapProtoV1.app.message.navMapData.SpellLimitPolygonProto.poly", "poly", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return mapProtoV1.app.message.navMapData.PolygonProto_V1; });
		 ...
		 *  @private
		 */
		public static const UNLIMIT_SPELL_TYPE:RepeatedFieldDescriptor_TYPE_INT32 = new RepeatedFieldDescriptor_TYPE_INT32("mapProtoV1.app.message.navMapData.SpellLimitPolygonProto.unlimit_spell_type", "unlimitSpellType", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			for (var unlimitSpellType$index:uint = 0; unlimitSpellType$index < this.unlimitSpellType.length; ++unlimitSpellType$index) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, this.unlimitSpellType[unlimitSpellType$index]);
			}
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					if ((tag & 7) == com.netease.protobuf.WireType.LENGTH_DELIMITED) {
						com.netease.protobuf.ReadUtils.readPackedRepeated(input, com.netease.protobuf.ReadUtils.read_TYPE_INT32, this.unlimitSpellType);
						break;
					}
					this.unlimitSpellType.push(com.netease.protobuf.ReadUtils.read_TYPE_INT32(input));
					break;
				default:
