...
package starling.textures
{
     ...
     *  </listing>
     *  
     *  <strong>IStarlingTexture Frame</strong>
     *
     *  <p>If your images have transparent areas at their edges, you can make use of the 
     *  <code>frame</code> property of the IStarlingTexture class. Trim the texture by removing the 
     ...
     *  </listing>
     *
     *  <strong>IStarlingTexture Rotation</strong>
     *
    ...
    {
		protected var _atlasTexture:IStarlingTexture;
        ...
        public function TextureAtlas(texture:IStarlingTexture, atlasXml:XML=null)
        {
        ...
        public function get texture():IStarlingTexture { return _atlasTexture; }
		...
		/**-------------------------------------------------------------------------------*/
		/**
		 * 更新parent贴图Texture,guoqing.wen add 
		 * @param texture
		 * 
		 */
		public function updateTexture(texture:IStarlingTexture):void
		{
			_atlasTexture = texture;
		}
		
		/** 更新SubTexture */
		public function updateSubTexture(name:String, region:Rectangle,
										 rotated:Boolean=false):void
		{
			var sub:SubTexture = _subTextures[name];
			if (sub)
				sub.updateTexture(_atlasTexture, region, false, rotated);
		}
		/**-------------------------------------------------------------------------------*/
    }
}