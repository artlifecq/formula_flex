...
package starling.display
{
    ...
    public class MovieClip extends Image implements IAnimatable
    {
        ...
        public function MovieClip(textures:Vector.<IStarlingTexture>, fps:Number=12)
        {
        ...
        private function init(textures:Vector.<IStarlingTexture>, fps:Number):void
        {
        ...
        public function addFrame(texture:IStarlingTexture, sound:Sound=null, duration:Number=-1):void
        {
            addFrameAt(numFrames, texture, sound, duration);
        }
        
        /** Adds a frame at a certain index, optionally with a sound and a custom duration. */
        public function addFrameAt(frameID:int, texture:IStarlingTexture, sound:Sound=null, 
        ...
        public function getFrameTexture(frameID:int):IStarlingTexture
        {
            if (frameID < 0 || frameID >= numFrames) throw new ArgumentError("Invalid frame id");
        ...
        public function setFrameTexture(frameID:int, texture:IStarlingTexture):void
        {
            if (frameID < 0 || frameID >= numFrames) throw new ArgumentError("Invalid frame id");
...
{
    public function MovieClipFrame(texture:IStarlingTexture, duration:Number=0.1,  startTime:Number=0)
    {
