...
package starling.display
{
    ...
    public class MeshBatch extends Mesh
    {
        ...
        {
			/**before use meshBatch addMesh we make sure the mesh vertices is setup finish. 
			 *  because the setupVertices function is delayed by default, 
			 *  so if you call this method after give a texture to the mesh,
			 *  you should call setupVerticesImmediately first.
			 * @author wewell**/
        ...
        override public function render(painter:Painter):void
        {
			...
			_lastActiveTime = painter.lastActiveTime;
		...
		private var _lastActiveTime:int;
		public function get lastActiveTime():int
		{
