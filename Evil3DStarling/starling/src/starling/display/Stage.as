...
package starling.display
{
    ...
    public class Stage extends DisplayObjectContainer
    {
        ...
        {
            if (!visible || !touchable || touchAcross) return null;
                                         ...
                                         transparent:Boolean=true):BitmapData
        {
            ...
            if (destination == null)
            {
                var width:int  = painter.backBufferWidth;//context.backBufferWidth;
                var height:int = painter.backBufferHeight//context.backBufferHeight; wewell
