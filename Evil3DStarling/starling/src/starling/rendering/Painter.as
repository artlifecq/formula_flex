...
package starling.rendering
{
    ...
    public class Painter
    {
        ...
        public function Painter(stage3D:Stage3D, stage3DProxy:Stage3DProxy = null,viewPort:Rectangle=null)
        {
            _stage3D = stage3D;
        ...
        private function applyClipRect():void
        {
            ...
            if (clipRect)
            {
                ...
                var renderTarget:IStarlingTexture = _state.renderTarget;

                if (renderTarget)
                {
                    width  = renderTarget.root.width;
                    height = renderTarget.root.height;
                }
                else
                {
