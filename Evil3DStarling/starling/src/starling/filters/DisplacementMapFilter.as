...
package starling.filters
{
    ...
    public class DisplacementMapFilter extends FragmentFilter
    {
        ...
        public function DisplacementMapFilter(mapTexture:IStarlingTexture,
        ...
        private function updateVertexData(inputTexture:IStarlingTexture, mapTexture:IStarlingTexture,
                                          mapOffsetX:Number=0.0, mapOffsetY:Number=0.0):void
        {
            ...
            TextureHelper.setTexCoords(mapTexture,vertexData, 0, "mapTexCoords", -mapX, -mapY);
			TextureHelper.setTexCoords(mapTexture,vertexData, 1, "mapTexCoords", -mapX + maxU, -mapY);
			TextureHelper.setTexCoords(mapTexture,vertexData, 2, "mapTexCoords", -mapX, -mapY + maxV);
			TextureHelper.setTexCoords(mapTexture,vertexData, 3, "mapTexCoords", -mapX + maxU, -mapY + maxV);
        }
        ...
        public function get mapTexture():IStarlingTexture { return dispEffect.mapTexture; }
...
class DisplacementMapEffect extends FilterEffect
{
    ...
    private var _mapTexture:IStarlingTexture;
    ...
    override protected function beforeDraw(stage3DProxy:Stage3DProxy):void
    {
        ...
        if (_mapTexture)
        {
            ...
            vertexFormat.setVertexBufferAt(stage3DProxy, 2, vertexBuffer, "mapTexCoords");
			stage3DProxy.setProgramConstantsFromVector(Context3DProgramType.FRAGMENT, 0, sOffset);
			stage3DProxy.setProgramConstantsFromMatrix(Context3DProgramType.FRAGMENT, 1, sMatrix, true);
			stage3DProxy.setTextureAt(1,_mapTexture.root);
        }
    }
    ...
    override protected function afterDraw(stage3DProxy:Stage3DProxy):void
    {
        if (_mapTexture)
        {
			stage3DProxy.setVertexBufferAt(2, null);
    ...
    private function getMapMatrix(out:Matrix3D):Matrix3D
    {
        ...
        var textureWidth:Number  = texture.root.width;
        var textureHeight:Number = texture.root.height;
