...
package starling.filters
{
    ...
    public class DropShadowFilter extends FragmentFilter
    {
        ...
        {
            var shadow:IStarlingTexture = _blurFilter.process(painter, helper, input0);
            var result:IStarlingTexture = _compositeFilter.process(painter, helper, shadow, input0);
