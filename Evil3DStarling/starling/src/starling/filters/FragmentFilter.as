...
package starling.filters
{
    ...
    public class FragmentFilter extends EventDispatcher
    {
        ...
        public function dispose():void
        {
			...
			_numragmentFilter--;
			trace("[Starling]dispose FragmentFilter!numFragmentFilter:",_numragmentFilter);
        }
                                ...
                                input2:IStarlingTexture=null, input3:IStarlingTexture=null):IStarlingTexture
        {
            ...
            var renderTarget:IStarlingTexture;
			...
			TextureHelper.setupTextureCoordinates(input0,vertexData);
...
class FilterQuad extends Mesh
{
    ...
    {
        super.texture = value;
        if (value) TextureHelper.setupTextureCoordinates(value,vertexData);
    }
}