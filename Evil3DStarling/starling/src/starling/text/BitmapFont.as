...
package starling.text
{
    ...
    public class BitmapFont implements ITextCompositor
    {
        ...
        public function BitmapFont(texture:IStarlingTexture=null, fontXml:XML=null)
        {
        ...
        private function parseFontXml(fontXml:XML):void
        {
            ...
            for each (var charElement:XML in fontXml.chars.char)
            {
                ...
                region.x = parseFloat(charElement.@x);
                region.y = parseFloat(charElement.@y);
                region.width  = parseFloat(charElement.@width);
                region.height = parseFloat(charElement.@height);
                
                var texture:IStarlingTexture = TextureFactory.fromTexture(_texture, region);
                                      ...
                                      format:TextFormat, options:TextOptions=null):void
        {
            ...
            for (var i:int=0; i<numChars; ++i)
            {
				...
				_helperImage.setupVerticesImmediately();
