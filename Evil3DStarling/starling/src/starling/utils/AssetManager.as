...
package starling.utils
{
     ...
     *    <li>IStarlingTexture atlases</li>
     *    <li>Bitmap Fonts</li>
     *    <li>Sounds</li>
     *    <li>XML data</li>
     *    <li>JSON data</li>
    ...
    public class AssetManager extends EventDispatcher
    {
        ...
        public function AssetManager(useMipmaps:Boolean=false)
        {
            _defaultTextureOptions = new TextureOptions(useMipmaps);
        ...
        {
            for each (var texture:IStarlingTexture in _textures)
                texture.dispose();
        ...
        public function getTexture(name:String):IStarlingTexture
        {
            ...
            else
            {
                for each (var atlas:TextureAtlas in _atlases)
                {
                    var texture:IStarlingTexture = atlas.getTexture(name);
        ...
        public function getTextures(prefix:String="", out:Vector.<IStarlingTexture>=null):Vector.<IStarlingTexture>
        {
            if (out == null) out = new <IStarlingTexture>[];
         ...
         *  by the new one. */
        public function addTexture(name:String, texture:IStarlingTexture):void
        {
        ...
        public function loadQueue(onProgress:Function):void
        {
            ...
            function processXmls():void
            {
                ...
                // have to be available for other XMLs. IStarlingTexture atlases are processed first:
                                         ...
                                         onProgress:Function, onComplete:Function):void
        {
            ...
            function process(asset:Object):void
            {
                ...
                {
                    texture = TextureFactory.fromBitmap(Bitmap(asset), options.mipMapping, options.optimizeForRenderToTexture,options.format);
                ...
                else if (asset is ByteArray)
                {
                    ...
                    if (TextureUtils.getTextureFormatFromRawData(bytes) == TextureFormatEnum.ATF)
                    {
                        texture = TextureFactory.fromAtfBytes(bytes,options.mipMapping);
						addTexture(name, texture);
						onComplete();
                    }
         ...
         *  <code>IStarlingTexture</code> class instead of the more memory efficient <code>RectangleTexture</code>.
         *  @default false */
