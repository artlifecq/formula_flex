package scenes
{
    ...
    public class FilterScene extends Scene
    {
        ...
        private var _displacementMap:IStarlingTexture;
        ...
        private function createDisplacementMap(width:Number, height:Number):IStarlingTexture
        {
            var scale:Number = Starling.contentScaleFactor;
            var map:BitmapData = new BitmapData(width*scale, height*scale, false);
            map.perlinNoise(20*scale, 20*scale, 3, 5, false, true);
            var texture:IStarlingTexture = TextureFactory.fromBitmapData(map, false, false);
            return texture;
        }
    }
}