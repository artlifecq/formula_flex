package scenes
{
    ...
    public class Sprite3DScene extends Scene
    {
        ...
        {
            var texture:IStarlingTexture = Game.assets.getTexture("gamua-logo");
        ...
        private function createCube(texture:IStarlingTexture):Sprite3D
        {
        ...
        private function createSidewall(texture:IStarlingTexture, color:uint=0xffffff):Sprite3D
        {
