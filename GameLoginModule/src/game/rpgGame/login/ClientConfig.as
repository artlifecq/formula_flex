package game.rpgGame.login
{
	...
	public class ClientConfig
	{
		...
		public static function setup($urlParam : Object = null, serverVersion : uint = 0, $isRelease : Boolean = false, uiCompressed : Boolean = true, $isWeiDuan : Boolean = false, useWorker : Boolean = false) : void
		{
...
//		}
		...
		public static function get useWorker() : Boolean
		{
			return _useWorker;
		}
	}
