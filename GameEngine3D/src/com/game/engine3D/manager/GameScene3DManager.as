package com.game.engine3D.manager
{
	...
	public class GameScene3DManager
	{
		...
		public static function createScene(name : String, view : View3D, viewDistance : int = 1000, areaMapLayer : int = 0, viewFilter : Function = null) : GameScene3D
		{
			var gameScene : GameScene3D = _sceneMap.getValue(name);
			if (!gameScene)
			{
				gameScene = new GameScene3D(name, view, viewDistance, areaMapLayer, viewFilter);
