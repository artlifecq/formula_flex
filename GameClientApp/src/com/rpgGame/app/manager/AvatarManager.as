...
//					ru.addUnitAtComposite(ru);
		...
		public static function callEquipmentChange(role : SceneRole) : void
		{
			...
			var bodyResID : String = "role/17/male_fashi_animation";//"pc/woman/body/knife_an_suit_p2_006";//"pc/woman/body/an_suit_s2006_skin";
...
//			var mountResID : String = "pc/mount/an_mount_zhanma_002";
			...
			var weaponResID : String = "role/17/male_fashi_weapon";
