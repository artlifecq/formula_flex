	...
	public class GlobalSettingManager
	{
		public static function init() : void
		{
			...
			if (setting)
			{
				...
				SceneRoleSelectManager.setOutlineData(setting.outlineEffectSize, setting.outlineEffectStrength, setting.outlineEffectQuality, setting.outlineEnemyColor, setting.outlineFriendColor, setting.outlineNeutralColor);
			}
			update();
		}
