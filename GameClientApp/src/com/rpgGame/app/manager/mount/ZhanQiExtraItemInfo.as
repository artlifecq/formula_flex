package com.rpgGame.app.manager.mount
{
	...
	public class ZhanQiExtraItemInfo
	{
		...
		public function ZhanQiExtraItemInfo(id:int):void
		{
			_id = id;
		...
		public static function createInfo():void
		{
			...
			_list[519] = new ZhanQiExtraItemInfo(519);
			_list[520] = new ZhanQiExtraItemInfo(520);
			_itemPropIds = new Object();
			var items:Object = JSONUtil.decode( GlobalSheetData.getSettingInfo(517).q_string_value);
		...
		public static function getinfobyId(id:int):ZhanQiExtraItemInfo
		{
			return _list[id];
		}	
	}
