package com.rpgGame.app.manager.fight
{
	...
	public class FightValueUtil
	{
		...
		public static function getFightValueByEquip(itemInfo:ClientItemInfo):uint
		{
			...
			var fight:Number=waiGong/1+fangYu/0.00004+qiXue/7+mingZhong/0.00004+shanBi/0.00004+moFa/0.8+baoJiLv/0.00004+baoJiLv/0.00008;
			return fight;
		}
		
		public static function getMingZhong(itemInfo:ClientItemInfo):Number
		{
			var qItem:Q_item=itemInfo.qItem;
			var job:int=qItem.q_job;
			var sex:int=qItem.q_sex;
		...
		public static function getBaoJi(itemInfo:ClientItemInfo):Number
		{
			var qItem:Q_item=itemInfo.qItem;
			var job:int=qItem.q_job;
			var sex:int=qItem.q_sex;
		...
		public static function getGongJi(itemInfo:ClientItemInfo):Number
		{
			var qItem:Q_item=itemInfo.qItem;
			var job:int=qItem.q_job;
			var sex:int=qItem.q_sex;
