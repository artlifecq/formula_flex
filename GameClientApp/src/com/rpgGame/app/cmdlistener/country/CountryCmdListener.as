package com.rpgGame.app.cmdlistener.country
{
	...
	public class CountryCmdListener extends BaseBean
	{
		...
		{
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_COUNTRY_STATUS, onCountryStates);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_KING_CHANGED_BROADCAST, onKingChangedBroadcast);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_OTHER_COUNTRY_KING, onOtherCountryKing);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_COUNTRY_HISTORY_RECORDS, onHistoryRecords);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_COUNTRY_POWER_CHANGED, onPowerChanged);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_GET_COUNTRY_EXCHEQUER_AMOUNT, onExchequerAmount);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_GET_OFFICE, onGetOffice);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_YESTERDAY_INCOME_CHANGED, onYesterdayIncomeChanged);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_GET_MILITARY, onGetMilitary);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_GET_JIN_WEI_APPLICANT, onGetJinWeiApplicant);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_GET_JIN_WEI_APPLICANT_FAIL, onGetJinWeiApplicantFail);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_GET_JIN_WEI_REQUIRES, onGetJinWeiRequires);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_COUNTRY_EXCHEQUER_RECORDS, onCountryExchequerRecords);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_TONG_ZHI_LI_CHANGED, onTongZhiLiChanged);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_SET_OFFICER, onSetOfficer);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_SET_OFFICER_FAIL, onSetOfficerFail);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_OFFICE_RETIRE, onOfficeRetire);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_OFFICE_RETIRE_FAIL, onOfficeRetireFail);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_AROUND_OFFICER_CHANGED, onAroundOfficerChanged);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_OFFICER_CHANGED, onOfficerChanged);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_GET_OFFICE_SEAL, onGetOfficeSeal);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_GET_OFFICE_SEAL_FAIL, onGetOfficeSealFail);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_COUNTRY_JING_SHU_CHANGED, onCountryJingShuChanged);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_SENT_JIN_WEI_APPLICANT, onSentJinWeiApplicant);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_SENT_JIN_WEI_APPLICANT_FAIL, onSentJinWeiApplicantFail);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_RECEIVE_JIN_WEI_APPLICANT, onReceiveJinWeiApplicant);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_REPLY_JIN_WEI_APPLICANT, onReplyJinWeiApplicant);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_REPLY_JIN_WEI_APPLICANT_FAIL, onReplyJinWeiApplicantFail);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_RECEIVE_JIN_WEI_APPLICANT_REPLY, onReceiveJinWeiApplicantReply);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_CHANGE_TAX_RATE_BROADCAST, onTaxRateBroadcast);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_CHANGE_TAX_RATE_FAIL, onTaxRateFail);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_CHANGE_JIN_WEI_REQUIRES, onChangeJinWeiRequires);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_CHANGE_JIN_WEI_REQUIRES_BROADCAST, onChangeJinWeiRequiresBroadcast);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_CHANGE_JIN_WEI_REQUIRES_FAIL, onChangeJinWeiRequiresFail);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_CHANGE_MILITARY, onChangeMilitary);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_CHANGE_MILITARY_FAIL, onChangeMilitaryFail);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_ALL_COUNTRY_UNION_STATUS, onAllCountryUnionStatus);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_UNION_INVITE_OTHER, onUnionInviteOther);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_UNION_INVITE_OTHER_FAIL, onUnionInviteOtherFail);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_UNION_OTHER_INVITE_SELF, onUnionOtherInviteSelf);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_UNION_INVITEES_REPLY, onUnionInviteReply);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_OFFICIAL_UNION_BROADCAST, onOfficialUnion);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_UNION_OTHER_REPLY_INVITATION, onUnionOtherReplyInvite);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_UNION_INVITEES_REPLY_FAIL, onUnionInviteesReplyFail);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_UNION_BROADCAST, onUnionBroadcast);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_LIFT_UNION, onLeftUnion);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_LIFT_UNION_FAIL, onLeftUnionFail);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_LIFT_UNION_BROADCAST, onLeftUnionBroadcast);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_OFFICIAL_LIFT_UNION_BROADCAST, onOfficialLeftUnionBroadcast);
			SocketConnection_protoBuffer.addCmdListener(CountryModuleMessages.S2C_AUTO_LIFT_UNION_BROADCAST, onAutoLeftUnionBroadcast);
