package com.rpgGame.app.ui.main.chat.laba
{
	...
	{
		private const TOTAL_SHOW_TIME:int = 15000;	//单条显示时间
		...
		public function setData(info:ChatInfo):void
		{
			var userName:String = info.realShowName;
			var message:String = RichTextConfig.replaceUnitCodeToLabel(info.realShowMsg);
			var showStr:String = ChatUtil.getChatMessageByChannel(info.channel, userName + message);
			updateShow(showStr);
