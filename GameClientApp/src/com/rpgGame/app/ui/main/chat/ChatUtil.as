			...
			switch(msgInfo.type)
			{
				...
				case EnumChatChannelType.CHAT_CHANNEL_SILIAO:
				{
					if(msgInfo.playerId.ToGID()==MainRoleManager.actorID)
					{
						...
						return HtmlTextUtil.getTextColor(0xe58bff,"【" + ChatUtil.getChannelTitle(msgInfo.type) + "】"+HtmlTextUtil.underLine(replacePlayerShow(msgInfo.name,0xFFFFFF,msgInfo.playerId.hexValue)))+HtmlTextUtil.getTextColor(0xFFFFFF,"对你说 : ")+HtmlTextUtil.getTextColor(0xe58bff,str);
				}
