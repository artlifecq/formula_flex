package com.rpgGame.app.ui.main.miniMap
{
	 ...
	 */
	public class MapRoleIco extends Sprite
	{
		public var type : int;
		public var mapX : int;
		public var mapY : int;
		 ...
		 */
		public function MapRoleIco(color : uint = 0xb18f6d, radius : int = 2)
		{
			super();
			touchable = true;
			touchGroup = true;
		...
		{
			var url : String = "ui/mainui/map/flag/xun_lu.png";
			return url;
		}
		...
		{
			var url : String = "ui/mainui/map/flag/guai.png";
			return url;
		}
		...
		public static function getMapPlayerIcon(isMyCountry : Boolean) : String
		{
			var url : String;
			if (isMyCountry)
				url = "ui/mainui/map/flag/lv.png";
			else
				url = "ui/mainui/map/flag/di_guo.png";
			return url;
		}
		...
		{
			var url : String = "ui/mainui/map/flag/jia_zu.png";
			return url;
		}
