package com.rpgGame.app.ui.tips
{
	...
	public class SpellTip extends SkinUI implements ITip
	{
		...
		/** 技能proto **/
		private var spellProto:SpellProto;
		/** 头部技能图标icon **/
		...
		public function setTipData( data:* ):void
		{
			...
			if( spellProto.activeSpell == null )
			{
				//被动
			...
			else
			{
				...
				_spellTip.labCurDis.htmlText = LanguageConfig.getText( LangSpell.SPELL_TIPS_INFO2, spellProto.activeSpell.releaseRange / 100);
			}
			
			var isLearn:Boolean = MainRoleManager.actorInfo.spellList.hasTypeSpell( spellProto.spellType );//是否学习过了
			if( isLearn )
			{
				//学习过了
				...
				var curDescription:String = getDescription( spellProto.description, spellProto.additionalOriginValue, spellProto.beenAdditionalSpellType );
				...
				{
					//主动技能才有CD，魔法消耗
					_spellTip.labCurCD.htmlText = LanguageConfig.getText( LangSpell.SPELL_TIPS_INFO5, spellProto.activeSpell.cd / 1000 );
					_spellTip.labCurMagic.htmlText = LanguageConfig.getText( LangSpell.SPELL_TIPS_INFO6, spellProto.activeSpell.manaCost );
			...
			if( nextSpellProto.canLearnLevel <= MainRoleManager.actorInfo.level )
