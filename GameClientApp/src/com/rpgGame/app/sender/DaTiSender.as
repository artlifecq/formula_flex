package com.rpgGame.app.sender
{
	...
	public class DaTiSender extends BaseSender
	{
		...
		{
			_bytes.clear();
			SocketConnection.send(ExamModuleMessages.C2S_EXAM_GET_QUESTION, _bytes);
		}
		...
		public static function reqExamAnswerQuestion(answerIndex:int):void
		{
			...
			SocketConnection.send(ExamModuleMessages.C2S_EXAM_ANSWER_QUESTION, _bytes);
		}
		...
		public static function reqExamRemoveWrongAnswer(propType:int):void
		{
			...
			SocketConnection.send(ExamModuleMessages.C2S_EXAM_USE_GOOD_ANSWER, _bytes);
		}
		...
		{
			_bytes.clear();
			SocketConnection.send(ExamModuleMessages.C2S_EXAM_SELF_DATA, _bytes);
		}
		...
		{
			_bytes.clear();
			SocketConnection.send(ExamModuleMessages.C2S_EXAM_FOLLOW_MSG, _bytes);
		}
	}
}