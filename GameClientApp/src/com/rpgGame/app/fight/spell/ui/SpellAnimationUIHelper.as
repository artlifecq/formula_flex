package com.rpgGame.app.fight.spell.ui
{
	 ...
	 *
	 */
	public class SpellAnimationUIHelper
	{
		public function SpellAnimationUIHelper()
		{
		}
		 ...
		 * 
		 */		
		public static function addKnifeLightEffect(info : ReleaseSpellUIInfo) : void
		{
			return;
		 ...
		 * 
		 */		
		public static function addSelfEffect(info : ReleaseSpellUIInfo) : void
		{
			return;
			if (SceneManager.isSceneOtherRenderLimit)
				return;
...
//					effectRu.scaleZ = animatData.scaleZ > 0 ? animatData.scaleZ * 0.01 : 1;
		 ...
		 * 
		 */		
		public static function addDestEffect(destX : int, destZ : int, rotationY : int, info : ReleaseSpellUIInfo) : void
		{
			return;
			if (SceneManager.isSceneOtherRenderLimit)
				return;
...
//					}
		...
		public static function addRibbonEffect(info:ReleaseSpellUIInfo):void
		{
			return;
			if (SceneManager.isSceneOtherRenderLimit)
				return;
		 ...
		 * 
		 */		
		public static function addFlyEffect(info : ReleaseSpellUIInfo) : void
		{
			return;
			if (SceneManager.isSceneOtherRenderLimit)
				return;
...
//					}
		 ...
		 * 
		 */		
		private static function addFlyEffectOnce(info : ReleaseSpellUIInfo, 
                                                 effectRes : String, 
