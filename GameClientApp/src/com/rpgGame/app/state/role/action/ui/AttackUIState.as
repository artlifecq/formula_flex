package com.rpgGame.app.state.role.action.ui
{
	 ...
	 *
	 */
	public class AttackUIState extends ActionState
	{
		private var _stateReference : AttackUIStateReference;
		/**
		...
		public function AttackUIState()
		{
			super(RoleStateType.ACTION_ATTACK_UI);
		}
		...
		override public function execute() : void
		{
			if (_machine && !_machine.isInPool)
			{
				...
				if (_ref is AttackUIStateReference)
				{
					_stateReference = _ref as AttackUIStateReference;
...
//				totalFrameTm /= _speed;
		...
		private function onTotalFrameCmp() : void
		{
			if (_machine && !_machine.isInPool)
			{
				...
				var ref:AttackUIStateReference=_ref as AttackUIStateReference;
				if (ref) 
				{
					ref.actionCompleteCall();
				}
			}
		}
