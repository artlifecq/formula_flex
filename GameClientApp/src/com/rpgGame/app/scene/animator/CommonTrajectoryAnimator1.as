package com.rpgGame.app.scene.animator
{
	 ...
	 *
	 */
	public class CommonTrajectoryAnimator1 implements IRenderAnimator
	{
		...
		public function CommonTrajectoryAnimator1(spellInfo : ReleaseSpellInfo, targetPos : Vector3D, targetRole : SceneRole, totalTime : int, speed : int, isTrackTarget : Boolean, matchTerrain : Boolean, isFlyCross : Boolean, isAdaptiveTargetHeight : Boolean, moveDelay : int, playDelay : int, throwHeight : int, throwWeightRatio : int)
		{
