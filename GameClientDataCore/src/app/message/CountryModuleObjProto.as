package app.message {
	...
	public dynamic final class CountryModuleObjProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const HAS_COLLECT_SALARY:FieldDescriptor_TYPE_BOOL = new FieldDescriptor_TYPE_BOOL("app.message.CountryModuleObjProto.has_collect_salary", "hasCollectSalary", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const IS_TODAY_BEEN_SET_OFFICER:FieldDescriptor_TYPE_BOOL = new FieldDescriptor_TYPE_BOOL("app.message.CountryModuleObjProto.is_today_been_set_officer", "isTodayBeenSetOfficer", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const IS_COUNTRY_DONATE:FieldDescriptor_TYPE_BOOL = new FieldDescriptor_TYPE_BOOL("app.message.CountryModuleObjProto.is_country_donate", "isCountryDonate", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SET_DONT_TALK_TIMES:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.CountryModuleObjProto.set_dont_talk_times", "setDontTalkTimes", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CAPTIVITY_TIMES:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.CountryModuleObjProto.captivity_times", "captivityTimes", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const OFFICER_SET_UNTALK_END_TIME:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.CountryModuleObjProto.officer_set_untalk_end_time", "officerSetUntalkEndTime", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CAPTIVITY_END_TIME:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.CountryModuleObjProto.captivity_end_time", "captivityEndTime", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const WU_XUN:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.CountryModuleObjProto.wu_xun", "wuXun", (8 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.CountryModuleObjProto.CountryModuleWuXunProto; });
		 ...
		 *  @private
		 */
		public static const IS_TODAY_VOTE:FieldDescriptor_TYPE_BOOL = new FieldDescriptor_TYPE_BOOL("app.message.CountryModuleObjProto.is_today_vote", "isTodayVote", (9 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasHasCollectSalary) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_BOOL(output, has_collect_salary$field);
			}
			if (hasIsTodayBeenSetOfficer) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 2);
				com.netease.protobuf.WriteUtils.write_TYPE_BOOL(output, is_today_been_set_officer$field);
			}
			if (hasIsCountryDonate) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 3);
				com.netease.protobuf.WriteUtils.write_TYPE_BOOL(output, is_country_donate$field);
			}
			if (hasSetDontTalkTimes) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 4);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, set_dont_talk_times$field);
			}
			if (hasCaptivityTimes) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 5);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, captivity_times$field);
			}
			if (hasOfficerSetUntalkEndTime) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 6);
				com.netease.protobuf.WriteUtils.write_TYPE_INT64(output, officer_set_untalk_end_time$field);
			}
			if (hasCaptivityEndTime) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 7);
				com.netease.protobuf.WriteUtils.write_TYPE_INT64(output, captivity_end_time$field);
			}
			if (hasWuXun) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 8);
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, wu_xun$field);
			}
			if (hasIsTodayVote) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 9);
				com.netease.protobuf.WriteUtils.write_TYPE_BOOL(output, is_today_vote$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.hasCollectSalary = com.netease.protobuf.ReadUtils.read_TYPE_BOOL(input);
					break;
				case 2:
					...
					this.isTodayBeenSetOfficer = com.netease.protobuf.ReadUtils.read_TYPE_BOOL(input);
					break;
				case 3:
					...
					this.isCountryDonate = com.netease.protobuf.ReadUtils.read_TYPE_BOOL(input);
					break;
				case 4:
					...
					this.setDontTalkTimes = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 5:
					...
					this.captivityTimes = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 6:
					...
					this.officerSetUntalkEndTime = com.netease.protobuf.ReadUtils.read_TYPE_INT64(input);
					break;
				case 7:
					...
					this.captivityEndTime = com.netease.protobuf.ReadUtils.read_TYPE_INT64(input);
					break;
				case 8:
					if (wu_xun$count != 0) {
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.wuXun);
					break;
				case 9:
					...
					++is_today_vote$count;
					this.isTodayVote = com.netease.protobuf.ReadUtils.read_TYPE_BOOL(input);
					break;
				default:
