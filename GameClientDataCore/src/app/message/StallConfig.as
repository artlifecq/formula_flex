package app.message {
	...
	public dynamic final class StallConfig extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const MISC_DATA:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.StallConfig.misc_data", "miscData", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.StallMiscProto; });
		 ...
		 *  @private
		 */
		public static const TYPE_DATAS:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.StallConfig.type_datas", "typeDatas", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.StallTypeDatasProto; });
		 ...
		 *  @private
		 */
		public static const BUY_GOODS_DATAS:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.StallConfig.buy_goods_datas", "buyGoodsDatas", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.StallBuyGoodsDatasProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasTypeDatas) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, type_datas$field);
			}
			if (hasBuyGoodsDatas) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 3);
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, buy_goods_datas$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.typeDatas);
					break;
				case 3:
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.buyGoodsDatas);
					break;
				default:
