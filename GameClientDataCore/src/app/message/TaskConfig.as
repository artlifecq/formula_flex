package app.message {
	...
	public dynamic final class TaskConfig extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const CHAPTER_TASK:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.TaskConfig.chapter_task", "chapterTask", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.AllChapterTaskConfig; });
		 ...
		 *  @private
		 */
		public static const CHANCE_TASK:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.TaskConfig.chance_task", "chanceTask", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.ChanceTaskConfig; });
		 ...
		 *  @private
		 */
		public static const DAILY_TASK:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.TaskConfig.daily_task", "dailyTask", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.DailyTaskConfig; });
		 ...
		 *  @private
		 */
		public static const BRANCH_TASK:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("app.message.TaskConfig.branch_task", "branchTask", (4 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.BranchTaskConfig; });
		 ...
		 *  @private
		 */
		public static const TOU_JING_CONFIG:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.TaskConfig.tou_jing_config", "touJingConfig", (5 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.TouJingConfig; });
		 ...
		 *  @private
		 */
		public static const MI_XIN_CONFIG:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.TaskConfig.mi_xin_config", "miXinConfig", (6 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.MiXinConfig; });
		 ...
		 *  @private
		 */
		public static const TOU_ZHU_CONFIG:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.TaskConfig.tou_zhu_config", "touZhuConfig", (7 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.TouZhuConfig; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasChapterTask) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, chapter_task$field);
			}
			if (hasChanceTask) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 2);
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, chance_task$field);
			}
			if (hasDailyTask) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 3);
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, daily_task$field);
			}
			...
			if (hasTouJingConfig) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, tou_jing_config$field);
			}
			if (hasMiXinConfig) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 6);
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, mi_xin_config$field);
			}
			if (hasTouZhuConfig) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 7);
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, tou_zhu_config$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.chapterTask);
					break;
				case 2:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.chanceTask);
					break;
				case 3:
					...
					break;
				case 4:
					this.branchTask.push(com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, new app.message.BranchTaskConfig()));
					break;
				case 5:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.touJingConfig);
					break;
				case 6:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.miXinConfig);
					break;
				case 7:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.touZhuConfig);
					break;
				default:
