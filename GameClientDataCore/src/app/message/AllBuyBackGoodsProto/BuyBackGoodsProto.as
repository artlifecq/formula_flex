package app.message.AllBuyBackGoodsProto {
	...
	public dynamic final class BuyBackGoodsProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const GOODS:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.AllBuyBackGoodsProto.BuyBackGoodsProto.goods", "goods", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.GoodsProto; });
		 ...
		 *  @private
		 */
		public static const EXPIRE_TIME:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("app.message.AllBuyBackGoodsProto.BuyBackGoodsProto.expire_time", "expireTime", (2 << 3) | com.netease.protobuf.WireType.VARINT);
