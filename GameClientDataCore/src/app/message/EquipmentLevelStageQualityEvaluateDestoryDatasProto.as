package app.message {
	...
	public dynamic final class EquipmentLevelStageQualityEvaluateDestoryDatasProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const DATAS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("app.message.EquipmentLevelStageQualityEvaluateDestoryDatasProto.datas", "datas", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.EquipmentLevelStageQualityEvaluateDestoryDataProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				switch (tag >> 3) {
				case 1:
					this.datas.push(com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, new app.message.EquipmentLevelStageQualityEvaluateDestoryDataProto()));
					break;
				default:
