package app.message {
	...
	public dynamic final class CountryExchequerLogProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const TYPE:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("app.message.CountryExchequerLogProto.type", "type", (1 << 3) | com.netease.protobuf.WireType.VARINT, app.message.CountryExchequerLogProto.CountryExchequerLogType);
		 ...
		 *  @private
		 */
		public static const TIME:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("app.message.CountryExchequerLogProto.time", "time", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const AMOUNT:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("app.message.CountryExchequerLogProto.amount", "amount", (3 << 3) | com.netease.protobuf.WireType.VARINT);
