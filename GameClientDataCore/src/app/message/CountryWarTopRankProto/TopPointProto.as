package app.message.CountryWarTopRankProto {
	...
	public dynamic final class TopPointProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const POINT:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("app.message.CountryWarTopRankProto.TopPointProto.point", "point", (1 << 3) | com.netease.protobuf.WireType.VARINT);
