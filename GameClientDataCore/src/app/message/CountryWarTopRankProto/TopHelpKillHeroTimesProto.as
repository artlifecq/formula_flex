package app.message.CountryWarTopRankProto {
	...
	public dynamic final class TopHelpKillHeroTimesProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const HELP_KILL_HERO_TIMES:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.CountryWarTopRankProto.TopHelpKillHeroTimesProto.help_kill_hero_times", "helpKillHeroTimes", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasHelpKillHeroTimes) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT64(output, help_kill_hero_times$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.helpKillHeroTimes = com.netease.protobuf.ReadUtils.read_TYPE_INT64(input);
					break;
				default:
