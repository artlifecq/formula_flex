package app.message.CountryWarTopRankProto {
	...
	public dynamic final class TopKillHeroTimesProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const KILL_HERO_TIMES:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.CountryWarTopRankProto.TopKillHeroTimesProto.kill_hero_times", "killHeroTimes", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasKillHeroTimes) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT64(output, kill_hero_times$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.killHeroTimes = com.netease.protobuf.ReadUtils.read_TYPE_INT64(input);
					break;
				default:
