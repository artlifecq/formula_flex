	...
	public dynamic final class AllFamilyAnimalBarDatasProto extends com.netease.protobuf.Message {
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				switch (tag >> 3) {
				case 1:
					this.levelData.push(com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, new app.message.AllFamilyAnimalBarDatasProto.FamilyAnimalBarLevelDataProto()));
					break;
				default:
