package app.message {
	...
	public dynamic final class FamilyModuleObjProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const FAMILY_AUTO_ACCEPT_INVITE:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("app.message.FamilyModuleObjProto.family_auto_accept_invite", "familyAutoAcceptInvite", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const FAMILY_FORBID_OTHER_INVITE_ME_JOIN:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("app.message.FamilyModuleObjProto.family_forbid_other_invite_me_join", "familyForbidOtherInviteMeJoin", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const COLLAGE_LEARN_SPELLS:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.FamilyModuleObjProto.collage_learn_spells", "collageLearnSpells", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.FamilyCollageLearnSpellsProto; });
		 ...
		 *  @private
		 */
		public static const FAMILY_LI_LIAN:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("app.message.FamilyModuleObjProto.family_li_lian", "familyLiLian", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const FAMILY_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.FamilyModuleObjProto.family_info", "familyInfo", (40 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.FamilyModuleObjProto.FamilyInfoProto; });
		 ...
		 *  @private
		 */
		public static const OFFICER_POS:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("app.message.FamilyModuleObjProto.officer_pos", "officerPos", (41 << 3) | com.netease.protobuf.WireType.VARINT, app.message.CountryOfficerPos);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasCollageLearnSpells) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, collage_learn_spells$field);
			}
			if (hasFamilyLiLian) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 4);
				com.netease.protobuf.WriteUtils.write$TYPE_INT64(output, family_li_lian$field);
			}
			if (hasFamilyInfo) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 40);
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, family_info$field);
			}
			if (hasOfficerPos) {
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 3:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.collageLearnSpells);
					break;
				case 4:
					...
					this.familyLiLian = com.netease.protobuf.ReadUtils.read$TYPE_INT64(input);
					break;
				case 40:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.familyInfo);
					break;
				case 41:
