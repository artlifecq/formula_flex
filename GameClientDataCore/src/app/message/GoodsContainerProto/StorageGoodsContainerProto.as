package app.message.GoodsContainerProto {
	...
	public dynamic final class StorageGoodsContainerProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const UNLOCKED_PAGE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.GoodsContainerProto.StorageGoodsContainerProto.unlocked_page", "unlockedPage", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasUnlockedPage) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, unlocked_page$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					++unlocked_page$count;
					this.unlockedPage = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				default:
