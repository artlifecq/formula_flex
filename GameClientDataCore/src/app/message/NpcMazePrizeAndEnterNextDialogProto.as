package app.message {
	...
	public dynamic final class NpcMazePrizeAndEnterNextDialogProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const DATA:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.NpcMazePrizeAndEnterNextDialogProto.data", "data", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.MazeLevelPrizeDataProto; });
