package app.message {
	...
	public dynamic final class FestivalLotteryRuleConfigProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const START_TIME:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.FestivalLotteryRuleConfigProto.start_time", "startTime", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const END_TIME:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.FestivalLotteryRuleConfigProto.end_time", "endTime", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const TYPE:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.FestivalLotteryRuleConfigProto.type", "type", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const RULE_LIST:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("app.message.FestivalLotteryRuleConfigProto.rule_list", "ruleList", (5 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.FestivalLotteryRuleConfigProto.FestivalLotteryRuleProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 3:
					...
					break;
				case 5:
					this.ruleList.push(com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, new app.message.FestivalLotteryRuleConfigProto.FestivalLotteryRuleProto()));
					break;
				default:
