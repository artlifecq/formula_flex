package app.message {
	...
	public dynamic final class WelfareConfig extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const FIRST_RECHARGE_COUNT:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.WelfareConfig.first_recharge_count", "firstRechargeCount", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const LOGIN_PRIZE_COUNT:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.WelfareConfig.login_prize_count", "loginPrizeCount", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PHOENIX:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.WelfareConfig.phoenix", "phoenix", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.PhoenixProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasFirstRechargeCount) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, first_recharge_count$field);
			}
			if (hasLoginPrizeCount) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 2);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, login_prize_count$field);
			}
			if (hasPhoenix) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 3);
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, phoenix$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.firstRechargeCount = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 2:
					...
					this.loginPrizeCount = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 3:
					if (phoenix$count != 0) {
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.phoenix);
					break;
				default:
