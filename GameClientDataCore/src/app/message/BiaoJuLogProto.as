package app.message {
	...
	public dynamic final class BiaoJuLogProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const TIME:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.BiaoJuLogProto.time", "time", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const LOG_TYPE:FieldDescriptor_TYPE_ENUM = new FieldDescriptor_TYPE_ENUM("app.message.BiaoJuLogProto.log_type", "logType", (2 << 3) | com.netease.protobuf.WireType.VARINT, app.message.BiaoJuLogProto.BiaoJuLogType);
		 ...
		 *  @private
		 */
		public static const AMOUNT:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.BiaoJuLogProto.amount", "amount", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasLogType) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_ENUM(output, log_type$field);
			}
			if (hasAmount) {
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					...
					++log_type$count;
					this.logType = com.netease.protobuf.ReadUtils.read_TYPE_ENUM(input);
					break;
				case 3:
					if (amount$count != 0) {
