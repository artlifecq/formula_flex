package app.message.RechargeRebateProto {
	...
	public dynamic final class RechargeRebateSingleProto extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 4:
					if (prize$count != 0) {
						throw new flash.errors.IOError('Bad data format: RechargeRebateSingleProto.prize cannot be set twice.');
					}
					++prize$count;
