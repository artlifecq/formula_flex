package app.message.GuildNewsProto {
	...
	public dynamic final class UpgradeLevelProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const LEVEL_AFTER_UPGRADE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.GuildNewsProto.UpgradeLevelProto.level_after_upgrade", "levelAfterUpgrade", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasLevelAfterUpgrade) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, level_after_upgrade$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.levelAfterUpgrade = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				default:
