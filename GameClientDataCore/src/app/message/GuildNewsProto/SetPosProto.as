package app.message.GuildNewsProto {
	...
	public dynamic final class SetPosProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const HERO_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("app.message.GuildNewsProto.SetPosProto.hero_name", "heroName", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const POS:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("app.message.GuildNewsProto.SetPosProto.pos", "pos", (2 << 3) | com.netease.protobuf.WireType.VARINT, app.message.GuildOfficerPos);
		 ...
		 *  @private
		 */
		public static const IS_UP:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("app.message.GuildNewsProto.SetPosProto.is_up", "isUp", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasIsUp) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_BOOL(output, is_up$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 3:
					...
					++is_up$count;
					this.isUp = com.netease.protobuf.ReadUtils.read$TYPE_BOOL(input);
					break;
				default:
