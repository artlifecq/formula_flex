package app.message.GuildNewsProto {
	...
	public dynamic final class MaintainProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const INCOME_FAN_RONG_DU:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("app.message.GuildNewsProto.MaintainProto.income_fan_rong_du", "incomeFanRongDu", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const INCOME_MONEY:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("app.message.GuildNewsProto.MaintainProto.income_money", "incomeMoney", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const COST_FAN_RONG_DU:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("app.message.GuildNewsProto.MaintainProto.cost_fan_rong_du", "costFanRongDu", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const COST_MONEY:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("app.message.GuildNewsProto.MaintainProto.cost_money", "costMoney", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasIncomeFanRongDu) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT64(output, income_fan_rong_du$field);
			}
			if (hasIncomeMoney) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 2);
				com.netease.protobuf.WriteUtils.write$TYPE_INT64(output, income_money$field);
			}
			if (hasCostFanRongDu) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 3);
				com.netease.protobuf.WriteUtils.write$TYPE_INT64(output, cost_fan_rong_du$field);
			}
			if (hasCostMoney) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 4);
				com.netease.protobuf.WriteUtils.write$TYPE_INT64(output, cost_money$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.incomeFanRongDu = com.netease.protobuf.ReadUtils.read$TYPE_INT64(input);
					break;
				case 2:
					...
					++income_money$count;
					this.incomeMoney = com.netease.protobuf.ReadUtils.read$TYPE_INT64(input);
					break;
				case 3:
					...
					this.costFanRongDu = com.netease.protobuf.ReadUtils.read$TYPE_INT64(input);
					break;
				case 4:
					...
					++cost_money$count;
					this.costMoney = com.netease.protobuf.ReadUtils.read$TYPE_INT64(input);
					break;
				default:
