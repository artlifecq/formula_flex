package app.message.GuildNewsProto {
	...
	public dynamic final class CreateGuildProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const CREATE_HERO_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("app.message.GuildNewsProto.CreateGuildProto.create_hero_name", "createHeroName", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const GUILD_FLAG:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.GuildNewsProto.CreateGuildProto.guild_flag", "guildFlag", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.GuildFlagProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasCreateHeroName) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_STRING(output, create_hero_name$field);
			}
			if (hasGuildFlag) {
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.createHeroName = com.netease.protobuf.ReadUtils.read$TYPE_STRING(input);
					break;
				case 2:
