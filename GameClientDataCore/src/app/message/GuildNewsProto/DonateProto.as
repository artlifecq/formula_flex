package app.message.GuildNewsProto {
	...
	public dynamic final class DonateProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const DONATE_HERO_NAME:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("app.message.GuildNewsProto.DonateProto.donate_hero_name", "donateHeroName", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const MONEY:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.GuildNewsProto.DonateProto.money", "money", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasDonateHeroName) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_STRING(output, donate_hero_name$field);
			}
			if (hasMoney) {
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.donateHeroName = com.netease.protobuf.ReadUtils.read_TYPE_STRING(input);
					break;
				case 2:
					if (money$count != 0) {
