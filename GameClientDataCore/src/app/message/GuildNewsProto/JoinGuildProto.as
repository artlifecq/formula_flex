package app.message.GuildNewsProto {
	...
	public dynamic final class JoinGuildProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const JOIN_FAMILY_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("app.message.GuildNewsProto.JoinGuildProto.join_family_name", "joinFamilyName", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasJoinFamilyName) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_STRING(output, join_family_name$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.joinFamilyName = com.netease.protobuf.ReadUtils.read$TYPE_STRING(input);
					break;
				default:
