package app.message.GuildNewsProto {
	...
	public dynamic final class DemoteLevelProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const LEVEL_AFTER_DEMOTE:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.GuildNewsProto.DemoteLevelProto.level_after_demote", "levelAfterDemote", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DEMOTE_RETURN_MONEY:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.GuildNewsProto.DemoteLevelProto.demote_return_money", "demoteReturnMoney", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DEMOTE_RETURN_FAN_RONG_DU:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.GuildNewsProto.DemoteLevelProto.demote_return_fan_rong_du", "demoteReturnFanRongDu", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasLevelAfterDemote) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, level_after_demote$field);
			}
			if (hasDemoteReturnMoney) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 2);
				com.netease.protobuf.WriteUtils.write_TYPE_INT64(output, demote_return_money$field);
			}
			if (hasDemoteReturnFanRongDu) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 3);
				com.netease.protobuf.WriteUtils.write_TYPE_INT64(output, demote_return_fan_rong_du$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.levelAfterDemote = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 2:
					...
					this.demoteReturnMoney = com.netease.protobuf.ReadUtils.read_TYPE_INT64(input);
					break;
				case 3:
					...
					this.demoteReturnFanRongDu = com.netease.protobuf.ReadUtils.read_TYPE_INT64(input);
					break;
				default:
