package app.message.GuildNewsProto {
	...
	public dynamic final class LeaveGuildProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const LEAVE_FAMILY_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("app.message.GuildNewsProto.LeaveGuildProto.leave_family_name", "leaveFamilyName", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasLeaveFamilyName) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_STRING(output, leave_family_name$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.leaveFamilyName = com.netease.protobuf.ReadUtils.read$TYPE_STRING(input);
					break;
				default:
