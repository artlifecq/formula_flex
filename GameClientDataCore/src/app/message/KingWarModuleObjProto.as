package app.message {
	...
	public dynamic final class KingWarModuleObjProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const HAS_COLLECT_KING_GUILD_PRIZE:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("app.message.KingWarModuleObjProto.has_collect_king_guild_prize", "hasCollectKingGuildPrize", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasHasCollectKingGuildPrize) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_BOOL(output, has_collect_king_guild_prize$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.hasCollectKingGuildPrize = com.netease.protobuf.ReadUtils.read$TYPE_BOOL(input);
					break;
				default:
