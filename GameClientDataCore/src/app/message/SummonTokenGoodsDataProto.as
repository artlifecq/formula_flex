package app.message {
	...
	public dynamic final class SummonTokenGoodsDataProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const TOKEN_TYPE:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("app.message.SummonTokenGoodsDataProto.token_type", "tokenType", (1 << 3) | com.netease.protobuf.WireType.VARINT, app.message.SummonTokenGoodsDataProto.TokenType);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasTokenType) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_ENUM(output, token_type$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					++token_type$count;
					this.tokenType = com.netease.protobuf.ReadUtils.read$TYPE_ENUM(input);
					break;
				default:
