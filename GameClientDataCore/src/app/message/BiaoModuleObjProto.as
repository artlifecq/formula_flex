package app.message {
	...
	public dynamic final class BiaoModuleObjProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const TODAY_ACESS_PERSONAL_BIAO_TIMES:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.BiaoModuleObjProto.today_acess_personal_biao_times", "todayAcessPersonalBiaoTimes", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasTodayAcessPersonalBiaoTimes) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, today_acess_personal_biao_times$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.todayAcessPersonalBiaoTimes = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				default:
