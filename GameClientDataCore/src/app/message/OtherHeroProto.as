package app.message {
	...
	public dynamic final class OtherHeroProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const HERO_BASIC:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.OtherHeroProto.hero_basic", "heroBasic", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.HeroBasicOtherProto; });
		 ...
		 *  @private
		 */
		public static const GOODS_CONTAINER_MODULE_OBJ:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.OtherHeroProto.goods_container_module_obj", "goodsContainerModuleObj", (20 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.GoodsContainerModuleObjOtherProto; });
		 ...
		 *  @private
		 */
		public static const FAMILY_MODULE_OBJ:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.OtherHeroProto.family_module_obj", "familyModuleObj", (21 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.FamilyModuleObjOtherProto; });
		 ...
		 *  @private
		 */
		public static const SCENE_MODULE_OBJ:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.OtherHeroProto.scene_module_obj", "sceneModuleObj", (22 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.SceneModuleObjOtherProto; });
		 ...
		 *  @private
		 */
		public static const VIP_MODULE_OBJ:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.OtherHeroProto.vip_module_obj", "vipModuleObj", (23 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.VipModuleObjOtherProto; });
		 ...
		 *  @private
		 */
		public static const MOUNT_MODULE_OBJ:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.OtherHeroProto.mount_module_obj", "mountModuleObj", (25 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.MountModuleObjClientProto; });
		 ...
		 *  @private
		 */
		public static const COUNTRY_MODULE_OBJ:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.OtherHeroProto.country_module_obj", "countryModuleObj", (26 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.CountryModuleObjOtherProto; });
