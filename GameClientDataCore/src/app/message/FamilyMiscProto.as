package app.message {
	...
	public dynamic final class FamilyMiscProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const LEAVE_FAMILY_NEXT_JOIN_OR_CREATE_FAMILY_DURATION:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.FamilyMiscProto.leave_family_next_join_or_create_family_duration", "leaveFamilyNextJoinOrCreateFamilyDuration", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const LEAVE_FAMILY_ADD_CD_LEVEL:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.FamilyMiscProto.leave_family_add_cd_level", "leaveFamilyAddCdLevel", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const FAMILY_CREATE_MONEY:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.FamilyMiscProto.family_create_money", "familyCreateMoney", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const FAMILY_CREATE_GOODS:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.FamilyMiscProto.family_create_goods", "familyCreateGoods", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CHANGE_ANNOUNCEMENT_DURATION:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.FamilyMiscProto.change_announcement_duration", "changeAnnouncementDuration", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DONATE_MONEY_BASE:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.FamilyMiscProto.donate_money_base", "donateMoneyBase", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DONATE_MONEY_GIVE_CONTRIBUTION_POINT:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.FamilyMiscProto.donate_money_give_contribution_point", "donateMoneyGiveContributionPoint", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DONATE_GOODS_ID:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.FamilyMiscProto.donate_goods_id", "donateGoodsId", (8 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DONATE_GOODS_UPGRADE_DATA:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.FamilyMiscProto.donate_goods_upgrade_data", "donateGoodsUpgradeData", (9 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.UpgradeProto; });
		 ...
		 *  @private
		 */
		public static const DONATE_GOODS_GIVE_CONTRIBUTION_POINT:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.FamilyMiscProto.donate_goods_give_contribution_point", "donateGoodsGiveContributionPoint", (10 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const FAMILY_ANIMAL_BAR_DUNGEON_START_TIME:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.FamilyMiscProto.family_animal_bar_dungeon_start_time", "familyAnimalBarDungeonStartTime", (11 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const FAMILY_ANIMAL_BAR_DUNGEON_END_TIME:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.FamilyMiscProto.family_animal_bar_dungeon_end_time", "familyAnimalBarDungeonEndTime", (12 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const FAMILY_ANIMAL_BAR_DUNGEON_TIME_LIMIT:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.FamilyMiscProto.family_animal_bar_dungeon_time_limit", "familyAnimalBarDungeonTimeLimit", (13 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const NORMAL_FAMILY_MEMBER_IMPEACH_LEADER_NEED_LEADER_OFFLINE_DURATION:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.FamilyMiscProto.normal_family_member_impeach_leader_need_leader_offline_duration", "normalFamilyMemberImpeachLeaderNeedLeaderOfflineDuration", (14 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasLeaveFamilyNextJoinOrCreateFamilyDuration) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT64(output, leave_family_next_join_or_create_family_duration$field);
			}
			if (hasLeaveFamilyAddCdLevel) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 2);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, leave_family_add_cd_level$field);
			}
			if (hasFamilyCreateMoney) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 3);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, family_create_money$field);
			}
			if (hasFamilyCreateGoods) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 4);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, family_create_goods$field);
			}
			if (hasChangeAnnouncementDuration) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 5);
				com.netease.protobuf.WriteUtils.write_TYPE_INT64(output, change_announcement_duration$field);
			}
			...
			if (hasDonateGoodsId) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, donate_goods_id$field);
			}
			if (hasDonateGoodsUpgradeData) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 9);
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, donate_goods_upgrade_data$field);
			}
			if (hasDonateGoodsGiveContributionPoint) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 10);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, donate_goods_give_contribution_point$field);
			}
			if (hasFamilyAnimalBarDungeonStartTime) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 11);
				com.netease.protobuf.WriteUtils.write_TYPE_INT64(output, family_animal_bar_dungeon_start_time$field);
			}
			if (hasFamilyAnimalBarDungeonEndTime) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 12);
				com.netease.protobuf.WriteUtils.write_TYPE_INT64(output, family_animal_bar_dungeon_end_time$field);
			}
			if (hasFamilyAnimalBarDungeonTimeLimit) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 13);
				com.netease.protobuf.WriteUtils.write_TYPE_INT64(output, family_animal_bar_dungeon_time_limit$field);
			}
			if (hasNormalFamilyMemberImpeachLeaderNeedLeaderOfflineDuration) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 14);
				com.netease.protobuf.WriteUtils.write_TYPE_INT64(output, normal_family_member_impeach_leader_need_leader_offline_duration$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.leaveFamilyNextJoinOrCreateFamilyDuration = com.netease.protobuf.ReadUtils.read_TYPE_INT64(input);
					break;
				case 2:
					...
					this.leaveFamilyAddCdLevel = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 3:
					...
					this.familyCreateMoney = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 4:
					...
					this.familyCreateGoods = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 5:
					...
					this.changeAnnouncementDuration = com.netease.protobuf.ReadUtils.read_TYPE_INT64(input);
					break;
				case 6:
				...
				case 8:
					...
					this.donateGoodsId = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 9:
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.donateGoodsUpgradeData);
					break;
				case 10:
					...
					this.donateGoodsGiveContributionPoint = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 11:
					...
					this.familyAnimalBarDungeonStartTime = com.netease.protobuf.ReadUtils.read_TYPE_INT64(input);
					break;
				case 12:
					...
					this.familyAnimalBarDungeonEndTime = com.netease.protobuf.ReadUtils.read_TYPE_INT64(input);
					break;
				case 13:
					...
					this.familyAnimalBarDungeonTimeLimit = com.netease.protobuf.ReadUtils.read_TYPE_INT64(input);
					break;
				case 14:
					...
					this.normalFamilyMemberImpeachLeaderNeedLeaderOfflineDuration = com.netease.protobuf.ReadUtils.read_TYPE_INT64(input);
					break;
				default:
