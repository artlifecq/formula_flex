package app.message {
	...
	public dynamic final class WatchWarCountryOfficeProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const ATTACK_COUNTRY:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.WatchWarCountryOfficeProto.attack_country", "attackCountry", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ATTACK_COUNTRY_OFFICERS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("app.message.WatchWarCountryOfficeProto.attack_country_officers", "attackCountryOfficers", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.CountryPosOfficersProto; });
		 ...
		 *  @private
		 */
		public static const DEFENCE_COUNTRY:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.WatchWarCountryOfficeProto.defence_country", "defenceCountry", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DEFENCE_COUNTRY_OFFICERS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("app.message.WatchWarCountryOfficeProto.defence_country_officers", "defenceCountryOfficers", (4 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.CountryPosOfficersProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			for (var attackCountryOfficers$index:uint = 0; attackCountryOfficers$index < this.attackCountryOfficers.length; ++attackCountryOfficers$index) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, this.attackCountryOfficers[attackCountryOfficers$index]);
			}
			...
			for (var defenceCountryOfficers$index:uint = 0; defenceCountryOfficers$index < this.defenceCountryOfficers.length; ++defenceCountryOfficers$index) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, this.defenceCountryOfficers[defenceCountryOfficers$index]);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					break;
				case 2:
					this.attackCountryOfficers.push(com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, new app.message.CountryPosOfficersProto()));
					break;
				case 3:
					...
					break;
				case 4:
					this.defenceCountryOfficers.push(com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, new app.message.CountryPosOfficersProto()));
					break;
				default:
