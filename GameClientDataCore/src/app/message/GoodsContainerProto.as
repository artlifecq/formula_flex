package app.message {
	...
	public dynamic final class GoodsContainerProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const INIT_COUNT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.GoodsContainerProto.init_count", "initCount", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SIZE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.GoodsContainerProto.size", "size", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const POS_LIST:RepeatedFieldDescriptor$TYPE_INT32 = new RepeatedFieldDescriptor$TYPE_INT32("app.message.GoodsContainerProto.pos_list", "posList", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const GOODS_LIST:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("app.message.GoodsContainerProto.goods_list", "goodsList", (4 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.GoodsProto; });
		 ...
		 *  @private
		 */
		public static const DEPOT:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.GoodsContainerProto.depot", "depot", (10 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.GoodsContainerProto.DepotGoodsContainerProto; });
		 ...
		 *  @private
		 */
		public static const STORAGE:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.GoodsContainerProto.storage", "storage", (11 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.GoodsContainerProto.StorageGoodsContainerProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasInitCount) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, init_count$field);
			}
			if (hasSize) {
			...
			for (var posList$index:uint = 0; posList$index < this.posList.length; ++posList$index) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, this.posList[posList$index]);
			}
			...
			if (hasDepot) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, depot$field);
			}
			if (hasStorage) {
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					++init_count$count;
					this.initCount = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 2:
					if (size$count != 0) {
				...
				case 3:
					if ((tag & 7) == com.netease.protobuf.WireType.LENGTH_DELIMITED) {
						com.netease.protobuf.ReadUtils.readPackedRepeated(input, com.netease.protobuf.ReadUtils.read$TYPE_INT32, this.posList);
						break;
					}
					this.posList.push(com.netease.protobuf.ReadUtils.read$TYPE_INT32(input));
					break;
				case 4:
					this.goodsList.push(com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, new app.message.GoodsProto()));
					break;
				case 10:
					if (depot$count != 0) {
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.depot);
					break;
				case 11:
					if (storage$count != 0) {
