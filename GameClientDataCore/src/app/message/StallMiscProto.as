package app.message {
	...
	public dynamic final class StallMiscProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const SELL_MAX_PRICE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.StallMiscProto.sell_max_price", "sellMaxPrice", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BUY_MAX_PRICE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.StallMiscProto.buy_max_price", "buyMaxPrice", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const STALL_TAX_PERCENT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.StallMiscProto.stall_tax_percent", "stallTaxPercent", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasSellMaxPrice) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, sell_max_price$field);
			}
			if (hasBuyMaxPrice) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 2);
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, buy_max_price$field);
			}
			if (hasStallTaxPercent) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 3);
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, stall_tax_percent$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.sellMaxPrice = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 2:
					...
					++buy_max_price$count;
					this.buyMaxPrice = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 3:
					...
					this.stallTaxPercent = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				default:
