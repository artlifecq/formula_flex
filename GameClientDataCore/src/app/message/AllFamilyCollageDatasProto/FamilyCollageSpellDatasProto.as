	...
	public dynamic final class FamilyCollageSpellDatasProto extends com.netease.protobuf.Message {
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			for (var spellData$index:uint = 0; spellData$index < this.spellData.length; ++spellData$index) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, this.spellData[spellData$index]);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				switch (tag >> 3) {
				case 1:
					this.spellData.push(com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, new app.message.AllFamilyCollageDatasProto.FamilyCollageSpellDatasProto.FamilyCollageSpellDataProto()));
					break;
				default:
