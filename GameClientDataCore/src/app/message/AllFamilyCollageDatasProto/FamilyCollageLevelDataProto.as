package app.message.AllFamilyCollageDatasProto {
	...
	public dynamic final class FamilyCollageLevelDataProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const BASE:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.AllFamilyCollageDatasProto.FamilyCollageLevelDataProto.base", "base", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.FamilyBuildingBaseDataLevelProto; });
