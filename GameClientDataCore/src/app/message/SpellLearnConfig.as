package app.message {
	...
	public dynamic final class SpellLearnConfig extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const RACE_SPELLS:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("app.message.SpellLearnConfig.race_spells", "raceSpells", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.SpellLearnRaceProto; });
		 ...
		 *  @private
		 */
		public static const CLEAR_SPELL_COST:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.SpellLearnConfig.clear_spell_cost", "clearSpellCost", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.UpgradeProto; });
		 ...
		 *  @private
		 */
		public static const CLEAR_SPELL_FREE_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.SpellLearnConfig.clear_spell_free_level", "clearSpellFreeLevel", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			for (var raceSpells$index:uint = 0; raceSpells$index < this.raceSpells.length; ++raceSpells$index) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, this.raceSpells[raceSpells$index]);
			}
			if (hasClearSpellCost) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 2);
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, clear_spell_cost$field);
			}
			if (hasClearSpellFreeLevel) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 3);
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, clear_spell_free_level$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				switch (tag >> 3) {
				case 1:
					this.raceSpells.push(com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, new app.message.SpellLearnRaceProto()));
					break;
				case 2:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.clearSpellCost);
					break;
				case 3:
					...
					this.clearSpellFreeLevel = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				default:
