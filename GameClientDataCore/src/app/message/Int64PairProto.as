package app.message {
	...
	public dynamic final class Int64PairProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const KEY:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("app.message.Int64PairProto.key", "key", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const VALUE:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("app.message.Int64PairProto.value", "value", (2 << 3) | com.netease.protobuf.WireType.VARINT);
