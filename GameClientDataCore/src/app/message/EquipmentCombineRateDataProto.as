package app.message {
	...
	public dynamic final class EquipmentCombineRateDataProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const QUALITY:FieldDescriptor_TYPE_ENUM = new FieldDescriptor_TYPE_ENUM("app.message.EquipmentCombineRateDataProto.quality", "quality", (1 << 3) | com.netease.protobuf.WireType.VARINT, app.message.Quality);
		 ...
		 *  @private
		 */
		public static const POINT_LOWER:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.EquipmentCombineRateDataProto.point_lower", "pointLower", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const POINT_UPPER:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.EquipmentCombineRateDataProto.point_upper", "pointUpper", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const RATE_DATAS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("app.message.EquipmentCombineRateDataProto.rate_datas", "rateDatas", (4 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.EquipmentQualityEvaluateRateDataProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasPointLower) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, point_lower$field);
			}
			if (hasPointUpper) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 3);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, point_upper$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					...
					++point_lower$count;
					this.pointLower = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 3:
					...
					++point_upper$count;
					this.pointUpper = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 4:
