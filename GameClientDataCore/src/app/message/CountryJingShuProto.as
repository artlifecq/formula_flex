package app.message {
	...
	public dynamic final class CountryJingShuProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const JING_SHU_COUNT:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.CountryJingShuProto.jing_shu_count", "jingShuCount", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasJingShuCount) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, jing_shu_count$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.jingShuCount = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				default:
