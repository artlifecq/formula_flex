package app.message {
	...
	public dynamic final class GoodsContainerModuleObjOtherProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const DEPOT:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.GoodsContainerModuleObjOtherProto.depot", "depot", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.GoodsContainerProto; });
		 ...
		 *  @private
		 */
		public static const HERO_EQUIPMENT:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.GoodsContainerModuleObjOtherProto.hero_equipment", "heroEquipment", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.HeroEquipmentListProto; });
