package app.message {
	...
	public dynamic final class RaceDataProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const RACE:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("app.message.RaceDataProto.race", "race", (1 << 3) | com.netease.protobuf.WireType.VARINT, app.message.RaceId);
		 ...
		 *  @private
		 */
		public static const MAIN_STAT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("app.message.RaceDataProto.main_stat", "mainStat", (2 << 3) | com.netease.protobuf.WireType.VARINT, app.message.StatType);
		 ...
		 *  @private
		 */
		public static const SECOND_STAT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("app.message.RaceDataProto.second_stat", "secondStat", (3 << 3) | com.netease.protobuf.WireType.VARINT, app.message.StatType);
		 ...
		 *  @private
		 */
		public static const CAN_SECOND_WEAPON_TYPES:RepeatedFieldDescriptor$TYPE_ENUM = new RepeatedFieldDescriptor$TYPE_ENUM("app.message.RaceDataProto.can_second_weapon_types", "canSecondWeaponTypes", (4 << 3) | com.netease.protobuf.WireType.VARINT, app.message.SecondWeaponType);
		 ...
		 *  @private
		 */
		public static const DEFAULT_SPELL:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.RaceDataProto.default_spell", "defaultSpell", (5 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.SpellProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasMainStat) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_ENUM(output, main_stat$field);
			}
			if (hasSecondStat) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 3);
				com.netease.protobuf.WriteUtils.write$TYPE_ENUM(output, second_stat$field);
			}
			for (var canSecondWeaponTypes$index:uint = 0; canSecondWeaponTypes$index < this.canSecondWeaponTypes.length; ++canSecondWeaponTypes$index) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_ENUM(output, this.canSecondWeaponTypes[canSecondWeaponTypes$index]);
			}
			if (hasDefaultSpell) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 5);
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, default_spell$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					...
					++main_stat$count;
					this.mainStat = com.netease.protobuf.ReadUtils.read$TYPE_ENUM(input);
					break;
				case 3:
					...
					++second_stat$count;
					this.secondStat = com.netease.protobuf.ReadUtils.read$TYPE_ENUM(input);
					break;
				case 4:
					if ((tag & 7) == com.netease.protobuf.WireType.LENGTH_DELIMITED) {
						com.netease.protobuf.ReadUtils.readPackedRepeated(input, com.netease.protobuf.ReadUtils.read$TYPE_ENUM, this.canSecondWeaponTypes);
						break;
					}
					this.canSecondWeaponTypes.push(com.netease.protobuf.ReadUtils.read$TYPE_ENUM(input));
					break;
				case 5:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.defaultSpell);
					break;
				default:
