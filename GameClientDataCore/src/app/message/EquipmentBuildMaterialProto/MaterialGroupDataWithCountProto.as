package app.message.EquipmentBuildMaterialProto {
	...
	public dynamic final class MaterialGroupDataWithCountProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const GROUP:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.EquipmentBuildMaterialProto.MaterialGroupDataWithCountProto.group", "group", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const COUNT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.EquipmentBuildMaterialProto.MaterialGroupDataWithCountProto.count", "count", (2 << 3) | com.netease.protobuf.WireType.VARINT);
