package app.message.CountryHistoryRecordProto {
	...
	public dynamic final class GuildTopRankProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const GUILD_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("app.message.CountryHistoryRecordProto.GuildTopRankProto.guild_name", "guildName", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const RANK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.CountryHistoryRecordProto.GuildTopRankProto.rank", "rank", (2 << 3) | com.netease.protobuf.WireType.VARINT);
