package app.message.CountryHistoryRecordProto {
	...
	public dynamic final class CountryWarAttackFailProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const ATTACK_KING_NAME:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("app.message.CountryHistoryRecordProto.CountryWarAttackFailProto.attack_king_name", "attackKingName", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const DEFENCE_COUNTRY_TYPE:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.CountryHistoryRecordProto.CountryWarAttackFailProto.defence_country_type", "defenceCountryType", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const WAR_TIME:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.CountryHistoryRecordProto.CountryWarAttackFailProto.war_time", "warTime", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const KILL_COUNT:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.CountryHistoryRecordProto.CountryWarAttackFailProto.kill_count", "killCount", (4 << 3) | com.netease.protobuf.WireType.VARINT);
