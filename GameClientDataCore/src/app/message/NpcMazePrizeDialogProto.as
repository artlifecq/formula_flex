package app.message {
	...
	public dynamic final class NpcMazePrizeDialogProto extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const DATA:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.NpcMazePrizeDialogProto.data", "data", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.MazeLevelPrizeDataProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (data$count != 0) {
						throw new flash.errors.IOError('Bad data format: NpcMazePrizeDialogProto.data cannot be set twice.');
					}
					++data$count;
