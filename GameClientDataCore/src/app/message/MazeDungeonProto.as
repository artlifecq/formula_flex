package app.message {
	...
	public dynamic final class MazeDungeonProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const FLOOR:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.MazeDungeonProto.floor", "floor", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PORTAL_DATAS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("app.message.MazeDungeonProto.portal_datas", "portalDatas", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.MazeDungeonProto.MazePortalDataProto; });
		 ...
		 *  @private
		 */
		public static const IS_RANDOM_FLOOR:FieldDescriptor_TYPE_BOOL = new FieldDescriptor_TYPE_BOOL("app.message.MazeDungeonProto.is_random_floor", "isRandomFloor", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const RANK_MONSTERS:RepeatedFieldDescriptor_TYPE_INT32 = new RepeatedFieldDescriptor_TYPE_INT32("app.message.MazeDungeonProto.rank_monsters", "rankMonsters", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const STAY_BEFORE_START_AREA:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.MazeDungeonProto.stay_before_start_area", "stayBeforeStartArea", (5 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.SquareAreaProto; });
		 ...
		 *  @private
		 */
		public static const HAS_MAZE_PRIZE_NPC:FieldDescriptor_TYPE_BOOL = new FieldDescriptor_TYPE_BOOL("app.message.MazeDungeonProto.has_maze_prize_npc", "hasMazePrizeNpc", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			for (var portalDatas$index:uint = 0; portalDatas$index < this.portalDatas.length; ++portalDatas$index) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, this.portalDatas[portalDatas$index]);
			}
			if (hasIsRandomFloor) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 3);
				com.netease.protobuf.WriteUtils.write_TYPE_BOOL(output, is_random_floor$field);
			}
			for (var rankMonsters$index:uint = 0; rankMonsters$index < this.rankMonsters.length; ++rankMonsters$index) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 4);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, this.rankMonsters[rankMonsters$index]);
			}
			if (hasStayBeforeStartArea) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 5);
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, stay_before_start_area$field);
			}
			if (hasHasMazePrizeNpc) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 6);
				com.netease.protobuf.WriteUtils.write_TYPE_BOOL(output, has_maze_prize_npc$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					break;
				case 2:
					this.portalDatas.push(com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, new app.message.MazeDungeonProto.MazePortalDataProto()));
					break;
				case 3:
					...
					this.isRandomFloor = com.netease.protobuf.ReadUtils.read_TYPE_BOOL(input);
					break;
				case 4:
					if ((tag & 7) == com.netease.protobuf.WireType.LENGTH_DELIMITED) {
						com.netease.protobuf.ReadUtils.readPackedRepeated(input, com.netease.protobuf.ReadUtils.read_TYPE_INT32, this.rankMonsters);
						break;
					}
					this.rankMonsters.push(com.netease.protobuf.ReadUtils.read_TYPE_INT32(input));
					break;
				case 5:
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.stayBeforeStartArea);
					break;
				case 6:
					...
					this.hasMazePrizeNpc = com.netease.protobuf.ReadUtils.read_TYPE_BOOL(input);
					break;
				default:
