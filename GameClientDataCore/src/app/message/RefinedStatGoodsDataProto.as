package app.message {
	...
	public dynamic final class RefinedStatGoodsDataProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const REFINED_TYPE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.RefinedStatGoodsDataProto.refined_type", "refinedType", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const REQUIRED_OBJECT_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.RefinedStatGoodsDataProto.required_object_level", "requiredObjectLevel", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasRefinedType) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, refined_type$field);
			}
			if (hasRequiredObjectLevel) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 2);
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, required_object_level$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					++refined_type$count;
					this.refinedType = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 2:
					...
					this.requiredObjectLevel = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				default:
