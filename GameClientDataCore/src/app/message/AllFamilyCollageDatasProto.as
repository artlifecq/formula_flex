package app.message {
	...
	public dynamic final class AllFamilyCollageDatasProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const LEVEL_DATA:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("app.message.AllFamilyCollageDatasProto.level_data", "levelData", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.AllFamilyCollageDatasProto.FamilyCollageLevelDataProto; });
		 ...
		 *  @private
		 */
		public static const SPELL_DATAS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("app.message.AllFamilyCollageDatasProto.spell_datas", "spellDatas", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.AllFamilyCollageDatasProto.FamilyCollageSpellDatasProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			for (var spellDatas$index:uint = 0; spellDatas$index < this.spellDatas.length; ++spellDatas$index) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, this.spellDatas[spellDatas$index]);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				switch (tag >> 3) {
				case 1:
					this.levelData.push(com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, new app.message.AllFamilyCollageDatasProto.FamilyCollageLevelDataProto()));
					break;
				case 2:
					this.spellDatas.push(com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, new app.message.AllFamilyCollageDatasProto.FamilyCollageSpellDatasProto()));
					break;
				default:
