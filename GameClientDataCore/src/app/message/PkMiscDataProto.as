package app.message {
	...
	public dynamic final class PkMiscDataProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const RED_NAME_PK_AMOUNT_THRESHOLD:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.PkMiscDataProto.red_name_pk_amount_threshold", "redNamePkAmountThreshold", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const YELLOW_NAME_PK_AMOUNT_THRESHOLD:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.PkMiscDataProto.yellow_name_pk_amount_threshold", "yellowNamePkAmountThreshold", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PK_MAX_AMOUNT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.PkMiscDataProto.pk_max_amount", "pkMaxAmount", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PK_AMOUNT_REDUCE_INTERVAL:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("app.message.PkMiscDataProto.pk_amount_reduce_interval", "pkAmountReduceInterval", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PK_AMOUNT_REDUCE_PER_TIMES:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.PkMiscDataProto.pk_amount_reduce_per_times", "pkAmountReducePerTimes", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasRedNamePkAmountThreshold) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, red_name_pk_amount_threshold$field);
			}
			if (hasYellowNamePkAmountThreshold) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 2);
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, yellow_name_pk_amount_threshold$field);
			}
			if (hasPkMaxAmount) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 3);
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, pk_max_amount$field);
			}
			if (hasPkAmountReduceInterval) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 4);
				com.netease.protobuf.WriteUtils.write$TYPE_INT64(output, pk_amount_reduce_interval$field);
			}
			if (hasPkAmountReducePerTimes) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 5);
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, pk_amount_reduce_per_times$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.redNamePkAmountThreshold = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 2:
					...
					this.yellowNamePkAmountThreshold = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 3:
					...
					++pk_max_amount$count;
					this.pkMaxAmount = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 4:
					...
					this.pkAmountReduceInterval = com.netease.protobuf.ReadUtils.read$TYPE_INT64(input);
					break;
				case 5:
					...
					this.pkAmountReducePerTimes = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				default:
