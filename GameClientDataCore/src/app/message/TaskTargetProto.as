package app.message {
	...
	public dynamic final class TaskTargetProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const CLIENT_EVENT:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.TaskTargetProto.client_event", "clientEvent", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const REPLY_NPC:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.TaskTargetProto.reply_npc", "replyNpc", (5 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.TaskTargetProto.ReplyNpcTargetProto; });
		 ...
		 *  @private
		 */
		public static const KILL_MONSTER:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.TaskTargetProto.kill_monster", "killMonster", (6 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.TaskTargetProto.KillMonsterTargetProto; });
		 ...
		 *  @private
		 */
		public static const DROP_GOODS:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.TaskTargetProto.drop_goods", "dropGoods", (7 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.TaskTargetProto.DropGoodsTargetProto; });
		 ...
		 *  @private
		 */
		public static const COLLECT_GOODS:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.TaskTargetProto.collect_goods", "collectGoods", (8 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.TaskTargetProto.CollectGoodsTargetProto; });
		 ...
		 *  @private
		 */
		public static const UPGRADE_LEVEL:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.TaskTargetProto.upgrade_level", "upgradeLevel", (9 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.TaskTargetProto.UpgradeLevelTargetProto; });
		 ...
		 *  @private
		 */
		public static const DEPOT_GOODS:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.TaskTargetProto.depot_goods", "depotGoods", (10 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.TaskTargetProto.DepotGoodsTargetProto; });
		 ...
		 *  @private
		 */
		public static const SEARCH_AREA:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.TaskTargetProto.search_area", "searchArea", (11 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.TaskTargetProto.SearchAreaTargetProto; });
		 ...
		 *  @private
		 */
		public static const CLIENT_TASK:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.TaskTargetProto.client_task", "clientTask", (12 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.TaskTargetProto.ClientTaskTargetProto; });
		 ...
		 *  @private
		 */
		public static const PLAYER_WAIT_TIME:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.TaskTargetProto.player_wait_time", "playerWaitTime", (13 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.TaskTargetProto.PlayerWaitTimeTargetProto; });
		 ...
		 *  @private
		 */
		public static const SENT_NPC:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.TaskTargetProto.sent_npc", "sentNpc", (14 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.TaskTargetProto.SentNpcTargetProto; });
		 ...
		 *  @private
		 */
		public static const VEHICLE_PLAYER:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.TaskTargetProto.vehicle_player", "vehiclePlayer", (15 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.TaskTargetProto.VehiclePlayerTargetProto; });
		 ...
		 *  @private
		 */
		public static const FINISH_STORY_DUNGEON:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.TaskTargetProto.finish_story_dungeon", "finishStoryDungeon", (16 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.TaskTargetProto.FinishStoryDungeonTargetProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasClientEvent) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, client_event$field);
			}
			if (hasReplyNpc) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 5);
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, reply_npc$field);
			}
			if (hasKillMonster) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 6);
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, kill_monster$field);
			}
			if (hasDropGoods) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 7);
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, drop_goods$field);
			}
			if (hasCollectGoods) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 8);
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, collect_goods$field);
			}
			if (hasUpgradeLevel) {
			...
			if (hasDepotGoods) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, depot_goods$field);
			}
			if (hasSearchArea) {
			...
			if (hasFinishStoryDungeon) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, finish_story_dungeon$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					++client_event$count;
					this.clientEvent = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 5:
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.replyNpc);
					break;
				case 6:
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.killMonster);
					break;
				case 7:
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.dropGoods);
					break;
				case 8:
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.collectGoods);
					break;
				case 9:
				...
				case 10:
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.depotGoods);
					break;
				case 11:
				...
				case 12:
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.clientTask);
					break;
				case 13:
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.playerWaitTime);
					break;
				case 14:
					if (sent_npc$count != 0) {
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.sentNpc);
					break;
				case 15:
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.vehiclePlayer);
					break;
				case 16:
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.finishStoryDungeon);
					break;
				default:
