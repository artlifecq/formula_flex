package app.message {
	...
	public dynamic final class DiscountStoreServerProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const COMBINE_SERVER_ID:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.DiscountStoreServerProto.combine_server_id", "combineServerId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const START_TIME:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.DiscountStoreServerProto.start_time", "startTime", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const END_TIME:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.DiscountStoreServerProto.end_time", "endTime", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const INDEX:RepeatedFieldDescriptor_TYPE_INT32 = new RepeatedFieldDescriptor_TYPE_INT32("app.message.DiscountStoreServerProto.index", "index", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BUY_COUNT:RepeatedFieldDescriptor_TYPE_INT32 = new RepeatedFieldDescriptor_TYPE_INT32("app.message.DiscountStoreServerProto.buy_count", "buyCount", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasCombineServerId) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, combine_server_id$field);
			}
			if (hasStartTime) {
			...
			for (var index$index:uint = 0; index$index < this.index.length; ++index$index) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, this.index[index$index]);
			}
			for (var buyCount$index:uint = 0; buyCount$index < this.buyCount.length; ++buyCount$index) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 5);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, this.buyCount[buyCount$index]);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.combineServerId = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 2:
				...
				case 4:
					if ((tag & 7) == com.netease.protobuf.WireType.LENGTH_DELIMITED) {
						com.netease.protobuf.ReadUtils.readPackedRepeated(input, com.netease.protobuf.ReadUtils.read_TYPE_INT32, this.index);
						break;
					}
					this.index.push(com.netease.protobuf.ReadUtils.read_TYPE_INT32(input));
					break;
				case 5:
					if ((tag & 7) == com.netease.protobuf.WireType.LENGTH_DELIMITED) {
						com.netease.protobuf.ReadUtils.readPackedRepeated(input, com.netease.protobuf.ReadUtils.read_TYPE_INT32, this.buyCount);
						break;
					}
					this.buyCount.push(com.netease.protobuf.ReadUtils.read_TYPE_INT32(input));
					break;
				default:
