package app.message {
	...
	public dynamic final class SpellProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("app.message.SpellProto.name", "name", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const SPELL_TYPE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.SpellProto.spell_type", "spellType", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SPELL_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.SpellProto.spell_level", "spellLevel", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const RACE:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("app.message.SpellProto.race", "race", (4 << 3) | com.netease.protobuf.WireType.VARINT, app.message.RaceId);
		 ...
		 *  @private
		 */
		public static const SECOND_WEAPON_TYPE:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("app.message.SpellProto.second_weapon_type", "secondWeaponType", (5 << 3) | com.netease.protobuf.WireType.VARINT, app.message.SecondWeaponType);
		 ...
		 *  @private
		 */
		public static const LEARN_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.SpellProto.learn_level", "learnLevel", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DESCRIPTION:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("app.message.SpellProto.description", "description", (7 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const FIGHTING_AMOUNT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.SpellProto.fighting_amount", "fightingAmount", (8 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ICON:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("app.message.SpellProto.icon", "icon", (9 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const IMAGE:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("app.message.SpellProto.image", "image", (10 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const VIDEO:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("app.message.SpellProto.video", "video", (11 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const AFFECT_TYPE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.SpellProto.affect_type", "affectType", (12 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BEEN_ADDITIONAL_SPELL_TYPE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.SpellProto.been_additional_spell_type", "beenAdditionalSpellType", (15 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ADDITIONAL_PERCENT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.SpellProto.additional_percent", "additionalPercent", (16 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ADDITIONAL_ORIGIN_VALUE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.SpellProto.additional_origin_value", "additionalOriginValue", (17 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CLIENT_SHOW_SPELL_TYPE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.SpellProto.client_show_spell_type", "clientShowSpellType", (20 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CLIENT_SUGGEST_SPELL_ID:RepeatedFieldDescriptor$TYPE_INT32 = new RepeatedFieldDescriptor$TYPE_INT32("app.message.SpellProto.client_suggest_spell_id", "clientSuggestSpellId", (21 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ACTIVE_SPELL:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.SpellProto.active_spell", "activeSpell", (30 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.ActiveSpellProto; });
		 ...
		 *  @private
		 */
		public static const PASSIVE_SPELL:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.SpellProto.passive_spell", "passiveSpell", (31 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.PassiveSpellProto; });
		 ...
		 *  @private
		 */
		public static const NEXT_SPELL:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.SpellProto.next_spell", "nextSpell", (40 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.SpellProto.NextSpellProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasLearnLevel) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, learn_level$field);
			}
			if (hasDescription) {
			...
			if (hasFightingAmount) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, fighting_amount$field);
			}
			if (hasIcon) {
			...
			if (hasVideo) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_STRING(output, video$field);
			}
			if (hasAffectType) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 12);
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, affect_type$field);
			}
			if (hasBeenAdditionalSpellType) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 15);
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, been_additional_spell_type$field);
			}
			if (hasAdditionalPercent) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 16);
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, additional_percent$field);
			}
			...
			if (hasClientShowSpellType) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, client_show_spell_type$field);
			}
			for (var clientSuggestSpellId$index:uint = 0; clientSuggestSpellId$index < this.clientSuggestSpellId.length; ++clientSuggestSpellId$index) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, this.clientSuggestSpellId[clientSuggestSpellId$index]);
			}
			if (hasActiveSpell) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 30);
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, active_spell$field);
			}
			if (hasPassiveSpell) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 31);
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, passive_spell$field);
			}
			if (hasNextSpell) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 40);
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, next_spell$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 6:
					...
					++learn_level$count;
					this.learnLevel = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 7:
				...
				case 8:
					...
					this.fightingAmount = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 9:
					if (icon$count != 0) {
				...
				case 11:
					...
					++video$count;
					this.video = com.netease.protobuf.ReadUtils.read$TYPE_STRING(input);
					break;
				case 12:
					...
					++affect_type$count;
					this.affectType = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 15:
					...
					this.beenAdditionalSpellType = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 16:
					...
					this.additionalPercent = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 17:
				...
				case 20:
					...
					this.clientShowSpellType = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 21:
					if ((tag & 7) == com.netease.protobuf.WireType.LENGTH_DELIMITED) {
						com.netease.protobuf.ReadUtils.readPackedRepeated(input, com.netease.protobuf.ReadUtils.read$TYPE_INT32, this.clientSuggestSpellId);
						break;
					}
					this.clientSuggestSpellId.push(com.netease.protobuf.ReadUtils.read$TYPE_INT32(input));
					break;
				case 30:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.activeSpell);
					break;
				case 31:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.passiveSpell);
					break;
				case 40:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.nextSpell);
					break;
				default:
