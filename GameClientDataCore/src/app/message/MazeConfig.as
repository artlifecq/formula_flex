package app.message {
	...
	public dynamic final class MazeConfig extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const MISC_DATA:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.MazeConfig.misc_data", "miscData", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.MazeMiscDataProto; });
