package app.message.FamilyNewsProto {
	...
	public dynamic final class MemberKillBossProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const KILL_BOSS_MEMBER:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.FamilyNewsProto.MemberKillBossProto.kill_boss_member", "killBossMember", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.FamilyNewsProto.MemberIdAndNameProto; });
		 ...
		 *  @private
		 */
		public static const BOSS_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("app.message.FamilyNewsProto.MemberKillBossProto.boss_name", "bossName", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const KILL_BOSS_SCENE_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.FamilyNewsProto.MemberKillBossProto.kill_boss_scene_id", "killBossSceneId", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasKillBossSceneId) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, kill_boss_scene_id$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 3:
					...
					this.killBossSceneId = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				default:
