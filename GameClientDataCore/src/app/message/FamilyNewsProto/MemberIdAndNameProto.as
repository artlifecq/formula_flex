package app.message.FamilyNewsProto {
	...
	public dynamic final class MemberIdAndNameProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const ID:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.FamilyNewsProto.MemberIdAndNameProto.id", "id", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const NAME:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("app.message.FamilyNewsProto.MemberIdAndNameProto.name", "name", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
