package app.message.FamilyNewsProto {
	...
	public dynamic final class MemberBeenKilledByBossProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const BOSS_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("app.message.FamilyNewsProto.MemberBeenKilledByBossProto.boss_name", "bossName", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const BEEN_KILL_BY_BOSS_SCENE_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.FamilyNewsProto.MemberBeenKilledByBossProto.been_kill_by_boss_scene_id", "beenKillByBossSceneId", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasBeenKillByBossMember) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, been_kill_by_boss_member$field);
			}
			if (hasBossName) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 2);
				com.netease.protobuf.WriteUtils.write$TYPE_STRING(output, boss_name$field);
			}
			if (hasBeenKillByBossSceneId) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 3);
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, been_kill_by_boss_scene_id$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.beenKillByBossMember);
					break;
				case 2:
					...
					++boss_name$count;
					this.bossName = com.netease.protobuf.ReadUtils.read$TYPE_STRING(input);
					break;
				case 3:
					...
					this.beenKillByBossSceneId = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				default:
