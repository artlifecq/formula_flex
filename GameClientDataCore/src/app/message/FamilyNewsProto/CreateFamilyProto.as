package app.message.FamilyNewsProto {
	...
	public dynamic final class CreateFamilyProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const CREATOR:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.FamilyNewsProto.CreateFamilyProto.creator", "creator", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.FamilyNewsProto.MemberIdAndNameProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasCreator) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, creator$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.creator);
					break;
				default:
