package app.message.FamilyNewsProto {
	...
	public dynamic final class MemberKillOtherProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const OTHER:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.FamilyNewsProto.MemberKillOtherProto.other", "other", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.FamilyNewsProto.MemberIdAndNameProto; });
		 ...
		 *  @private
		 */
		public static const KILL_OTHER_SCENE_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.FamilyNewsProto.MemberKillOtherProto.kill_other_scene_id", "killOtherSceneId", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasKillOtherMember) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, kill_other_member$field);
			}
			if (hasOther) {
			...
			if (hasKillOtherSceneId) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, kill_other_scene_id$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.killOtherMember);
					break;
				case 2:
					if (other$count != 0) {
				...
				case 3:
					...
					this.killOtherSceneId = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				default:
