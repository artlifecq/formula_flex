package app.message.FamilyNewsProto {
	...
	public dynamic final class AddMemberProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const ADD_MEMBER:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.FamilyNewsProto.AddMemberProto.add_member", "addMember", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.FamilyNewsProto.MemberIdAndNameProto; });
