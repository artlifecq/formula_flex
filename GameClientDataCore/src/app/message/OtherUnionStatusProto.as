package app.message {
	...
	public dynamic final class OtherUnionStatusProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const UNION_CD:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.OtherUnionStatusProto.union_cd", "unionCd", (1 << 3) | com.netease.protobuf.WireType.VARINT);
