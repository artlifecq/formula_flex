package app.message {
	...
	public dynamic final class EquipmentCombineCostDataProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const LEVEL_STAGE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.EquipmentCombineCostDataProto.level_stage", "levelStage", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const QUALITY:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("app.message.EquipmentCombineCostDataProto.quality", "quality", (2 << 3) | com.netease.protobuf.WireType.VARINT, app.message.Quality);
		 ...
		 *  @private
		 */
		public static const RATE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.EquipmentCombineCostDataProto.rate", "rate", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const COST:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.EquipmentCombineCostDataProto.cost", "cost", (4 << 3) | com.netease.protobuf.WireType.VARINT);
