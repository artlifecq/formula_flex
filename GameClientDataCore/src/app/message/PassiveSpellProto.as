package app.message {
	...
	public dynamic final class PassiveSpellProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const SPRITE_STAT:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.PassiveSpellProto.sprite_stat", "spriteStat", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.SpriteStatProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasSpriteStat) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, sprite_stat$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.spriteStat);
					break;
				default:
