package app.message {
	...
	public dynamic final class ZhanCheMonsterDataProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const ZHAN_CHE_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.ZhanCheMonsterDataProto.zhan_che_id", "zhanCheId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const MONSTER_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.ZhanCheMonsterDataProto.monster_id", "monsterId", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SPELLS:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("app.message.ZhanCheMonsterDataProto.spells", "spells", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.SpellProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasZhanCheId) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, zhan_che_id$field);
			}
			if (hasMonsterId) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 2);
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, monster_id$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					++zhan_che_id$count;
					this.zhanCheId = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 2:
