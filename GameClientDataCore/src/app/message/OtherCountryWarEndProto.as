package app.message {
	...
	public dynamic final class OtherCountryWarEndProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const WAR_TYPE:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("app.message.OtherCountryWarEndProto.war_type", "warType", (1 << 3) | com.netease.protobuf.WireType.VARINT, app.message.CountryWarType);
		 ...
		 *  @private
		 */
		public static const ATTACK_COUNTRY:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.OtherCountryWarEndProto.attack_country", "attackCountry", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DEFENCE_COUNTRY:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.OtherCountryWarEndProto.defence_country", "defenceCountry", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const WIN_COUNTRY:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.OtherCountryWarEndProto.win_country", "winCountry", (4 << 3) | com.netease.protobuf.WireType.VARINT);
