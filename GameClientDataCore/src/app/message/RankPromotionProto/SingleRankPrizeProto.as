package app.message.RankPromotionProto {
	...
	public dynamic final class SingleRankPrizeProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const GOODS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("app.message.RankPromotionProto.SingleRankPrizeProto.goods", "goods", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.GoodsWrapperProto; });
		 ...
		 *  @private
		 */
		public static const LEVEL:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.RankPromotionProto.SingleRankPrizeProto.level", "level", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const MIN_RANK:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.RankPromotionProto.SingleRankPrizeProto.min_rank", "minRank", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const MAX_RANK:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.RankPromotionProto.SingleRankPrizeProto.max_rank", "maxRank", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasMinRank) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, min_rank$field);
			}
			if (hasMaxRank) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 4);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, max_rank$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 3:
					...
					++min_rank$count;
					this.minRank = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 4:
					if (max_rank$count != 0) {
					...
					++max_rank$count;
					this.maxRank = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				default:
