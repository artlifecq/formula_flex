package app.message {
	...
	public dynamic final class BaZhenTuModuleObjProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const TODAY_ENTER_TIMES:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.BaZhenTuModuleObjProto.today_enter_times", "todayEnterTimes", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasTodayEnterTimes) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, today_enter_times$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.todayEnterTimes = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				default:
