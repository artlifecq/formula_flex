package app.message.TaskTargetProto {
	...
	public dynamic final class SentNpcTargetProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const SET_NPC_ACCEPT_NPC:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.TaskTargetProto.SentNpcTargetProto.set_npc_accept_npc", "setNpcAcceptNpc", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SET_NPC_ACCEPT_NPC_DIALOG:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("app.message.TaskTargetProto.SentNpcTargetProto.set_npc_accept_npc_dialog", "setNpcAcceptNpcDialog", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const SET_NPC_TARGET_AREA:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.TaskTargetProto.SentNpcTargetProto.set_npc_target_area", "setNpcTargetArea", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.AreaDataProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasSetNpcAcceptNpc) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, set_npc_accept_npc$field);
			}
			if (hasSetNpcAcceptNpcDialog) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 2);
				com.netease.protobuf.WriteUtils.write$TYPE_STRING(output, set_npc_accept_npc_dialog$field);
			}
			if (hasSetNpcTargetArea) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 3);
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, set_npc_target_area$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.setNpcAcceptNpc = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 2:
					...
					this.setNpcAcceptNpcDialog = com.netease.protobuf.ReadUtils.read$TYPE_STRING(input);
					break;
				case 3:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.setNpcTargetArea);
					break;
				default:
