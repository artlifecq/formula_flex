package app.message.TaskTargetProto {
	...
	public dynamic final class VehiclePlayerTargetProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const VEHICLE_PLAYER_NPC:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("app.message.TaskTargetProto.VehiclePlayerTargetProto.vehicle_player_npc", "vehiclePlayerNpc", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasVehiclePlayerNpc) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, vehicle_player_npc$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.vehiclePlayerNpc = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				default:
