package app.message.TaskTargetProto {
	...
	public dynamic final class PlayerWaitTimeTargetProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const PLAYER_WAIT_TIME:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("app.message.TaskTargetProto.PlayerWaitTimeTargetProto.player_wait_time", "playerWaitTime", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasPlayerWaitTime) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT64(output, player_wait_time$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.playerWaitTime = com.netease.protobuf.ReadUtils.read$TYPE_INT64(input);
					break;
				default:
