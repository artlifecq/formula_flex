package app.message {
	...
	public dynamic final class PackageProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const IS_OPEN:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("app.message.PackageProto.is_open", "isOpen", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PACKAGE_PRIZE:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("app.message.PackageProto.package_prize", "packagePrize", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.PrizeProto; });
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasPackagePrize) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_MESSAGE(output, package_prize$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					...
					com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.packagePrize);
					break;
				default:
