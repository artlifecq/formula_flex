package app.message {
	...
	public dynamic final class TradeConfig extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const TRADE_GOODS_LIMIT:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.TradeConfig.trade_goods_limit", "tradeGoodsLimit", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const TRADE_INVITE_EXPIRE_TIME:FieldDescriptor_TYPE_INT64 = new FieldDescriptor_TYPE_INT64("app.message.TradeConfig.trade_invite_expire_time", "tradeInviteExpireTime", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const TRADE_MAX_DISTANCE:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.TradeConfig.trade_max_distance", "tradeMaxDistance", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasTradeGoodsLimit) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, trade_goods_limit$field);
			}
			if (hasTradeInviteExpireTime) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 2);
				com.netease.protobuf.WriteUtils.write_TYPE_INT64(output, trade_invite_expire_time$field);
			}
			if (hasTradeMaxDistance) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 3);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, trade_max_distance$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.tradeGoodsLimit = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 2:
					...
					this.tradeInviteExpireTime = com.netease.protobuf.ReadUtils.read_TYPE_INT64(input);
					break;
				case 3:
					...
					this.tradeMaxDistance = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				default:
