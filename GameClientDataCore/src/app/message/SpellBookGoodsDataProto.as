package app.message {
	...
	public dynamic final class SpellBookGoodsDataProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const SPELL_TYPE:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.SpellBookGoodsDataProto.spell_type", "spellType", (1 << 3) | com.netease.protobuf.WireType.VARINT);
