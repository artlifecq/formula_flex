package app.message {
	...
	public dynamic final class PhoenixProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const PHOENIX_MONEY_REFINE:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("app.message.PhoenixProto.phoenix_money_refine", "phoenixMoneyRefine", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.PhoenixDataProto; });
		 ...
		 *  @private
		 */
		public static const PHOENIX_EXP_REFINE:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("app.message.PhoenixProto.phoenix_exp_refine", "phoenixExpRefine", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.PhoenixDataProto; });
		 ...
		 *  @private
		 */
		public static const PHOENIX_MONEY_REFINE_MAX_TIMES:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.PhoenixProto.phoenix_money_refine_max_times", "phoenixMoneyRefineMaxTimes", (71 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PHOENIX_EXP_REFINE_MAX_TIMES:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.PhoenixProto.phoenix_exp_refine_max_times", "phoenixExpRefineMaxTimes", (75 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			for (var phoenixMoneyRefine$index:uint = 0; phoenixMoneyRefine$index < this.phoenixMoneyRefine.length; ++phoenixMoneyRefine$index) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, this.phoenixMoneyRefine[phoenixMoneyRefine$index]);
			}
			for (var phoenixExpRefine$index:uint = 0; phoenixExpRefine$index < this.phoenixExpRefine.length; ++phoenixExpRefine$index) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, this.phoenixExpRefine[phoenixExpRefine$index]);
			}
			if (hasPhoenixMoneyRefineMaxTimes) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 71);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, phoenix_money_refine_max_times$field);
			}
			if (hasPhoenixExpRefineMaxTimes) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 75);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, phoenix_exp_refine_max_times$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				switch (tag >> 3) {
				case 1:
					this.phoenixMoneyRefine.push(com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, new app.message.PhoenixDataProto()));
					break;
				case 2:
					this.phoenixExpRefine.push(com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, new app.message.PhoenixDataProto()));
					break;
				case 71:
					...
					this.phoenixMoneyRefineMaxTimes = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 75:
					...
					this.phoenixExpRefineMaxTimes = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				default:
