package app.message {
	...
	public dynamic final class CollectObjectProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const NAME:FieldDescriptor_TYPE_BYTES = new FieldDescriptor_TYPE_BYTES("app.message.CollectObjectProto.name", "name", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const RESOURCE:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("app.message.CollectObjectProto.resource", "resource", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const IS_REVERSE:FieldDescriptor_TYPE_BOOL = new FieldDescriptor_TYPE_BOOL("app.message.CollectObjectProto.is_reverse", "isReverse", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SCENE_ID:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.CollectObjectProto.scene_id", "sceneId", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const OBJECT_ID:RepeatedFieldDescriptor_TYPE_INT32 = new RepeatedFieldDescriptor_TYPE_INT32("app.message.CollectObjectProto.object_id", "objectId", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const POS_X:RepeatedFieldDescriptor_TYPE_INT32 = new RepeatedFieldDescriptor_TYPE_INT32("app.message.CollectObjectProto.pos_x", "posX", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const POS_Y:RepeatedFieldDescriptor_TYPE_INT32 = new RepeatedFieldDescriptor_TYPE_INT32("app.message.CollectObjectProto.pos_y", "posY", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ACTION:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("app.message.CollectObjectProto.action", "action", (8 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const SCALE:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.CollectObjectProto.scale", "scale", (9 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DIRECTION:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.CollectObjectProto.direction", "direction", (10 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const IS_DYNAMIC_CREATE:FieldDescriptor_TYPE_BOOL = new FieldDescriptor_TYPE_BOOL("app.message.CollectObjectProto.is_dynamic_create", "isDynamicCreate", (11 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const COLLECT_SHOW:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("app.message.CollectObjectProto.collect_show", "collectShow", (12 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasResource) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_STRING(output, resource$field);
			}
			if (hasIsReverse) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 3);
				com.netease.protobuf.WriteUtils.write_TYPE_BOOL(output, is_reverse$field);
			}
			if (hasSceneId) {
			...
			for (var objectId$index:uint = 0; objectId$index < this.objectId.length; ++objectId$index) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, this.objectId[objectId$index]);
			}
			for (var posX$index:uint = 0; posX$index < this.posX.length; ++posX$index) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 6);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, this.posX[posX$index]);
			}
			for (var posY$index:uint = 0; posY$index < this.posY.length; ++posY$index) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 7);
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, this.posY[posY$index]);
			}
			if (hasAction) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 8);
				com.netease.protobuf.WriteUtils.write_TYPE_STRING(output, action$field);
			}
			if (hasScale) {
			...
			if (hasIsDynamicCreate) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_BOOL(output, is_dynamic_create$field);
			}
			if (hasCollectShow) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 12);
				com.netease.protobuf.WriteUtils.write_TYPE_STRING(output, collect_show$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					...
					++resource$count;
					this.resource = com.netease.protobuf.ReadUtils.read_TYPE_STRING(input);
					break;
				case 3:
					...
					++is_reverse$count;
					this.isReverse = com.netease.protobuf.ReadUtils.read_TYPE_BOOL(input);
					break;
				case 4:
					if (scene_id$count != 0) {
				...
				case 5:
					if ((tag & 7) == com.netease.protobuf.WireType.LENGTH_DELIMITED) {
						com.netease.protobuf.ReadUtils.readPackedRepeated(input, com.netease.protobuf.ReadUtils.read_TYPE_INT32, this.objectId);
						break;
					}
					this.objectId.push(com.netease.protobuf.ReadUtils.read_TYPE_INT32(input));
					break;
				case 6:
					if ((tag & 7) == com.netease.protobuf.WireType.LENGTH_DELIMITED) {
						com.netease.protobuf.ReadUtils.readPackedRepeated(input, com.netease.protobuf.ReadUtils.read_TYPE_INT32, this.posX);
						break;
					}
					this.posX.push(com.netease.protobuf.ReadUtils.read_TYPE_INT32(input));
					break;
				case 7:
					if ((tag & 7) == com.netease.protobuf.WireType.LENGTH_DELIMITED) {
						com.netease.protobuf.ReadUtils.readPackedRepeated(input, com.netease.protobuf.ReadUtils.read_TYPE_INT32, this.posY);
						break;
					}
					this.posY.push(com.netease.protobuf.ReadUtils.read_TYPE_INT32(input));
					break;
				case 8:
					if (action$count != 0) {
					...
					++action$count;
					this.action = com.netease.protobuf.ReadUtils.read_TYPE_STRING(input);
					break;
				case 9:
					if (scale$count != 0) {
				...
				case 11:
					...
					this.isDynamicCreate = com.netease.protobuf.ReadUtils.read_TYPE_BOOL(input);
					break;
				case 12:
					...
					++collect_show$count;
					this.collectShow = com.netease.protobuf.ReadUtils.read_TYPE_STRING(input);
					break;
				default:
