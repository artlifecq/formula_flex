package app.message.AllFamilyBiaoDatasProto {
	...
	public dynamic final class FamilyBiaoLevelDataProto extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (base$count != 0) {
						throw new flash.errors.IOError('Bad data format: FamilyBiaoLevelDataProto.base cannot be set twice.');
					}
					++base$count;
