package app.message.GoodsExchangeRuleConfigProto {
	...
	public dynamic final class GoodsExchangeRuleProto extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const COST_GOODS:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("app.message.GoodsExchangeRuleConfigProto.GoodsExchangeRuleProto.cost_goods", "costGoods", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.UpgradeProto; });
		 ...
		 *  @private
		 */
		public static const OBTAIN_GOODS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("app.message.GoodsExchangeRuleConfigProto.GoodsExchangeRuleProto.obtain_goods", "obtainGoods", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.GoodsWrapperProto; });
		 ...
		 *  @private
		 */
		public static const DETAIL_GOODS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("app.message.GoodsExchangeRuleConfigProto.GoodsExchangeRuleProto.detail_goods", "detailGoods", (4 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return app.message.GoodsWrapperProto; });
		 ...
		 *  @private
		 */
		public static const LIMIT:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.GoodsExchangeRuleConfigProto.GoodsExchangeRuleProto.limit", "limit", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const LIMIT_TYPE:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.GoodsExchangeRuleConfigProto.GoodsExchangeRuleProto.limit_type", "limitType", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const REQUIRE_VIP_LEVEL:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("app.message.GoodsExchangeRuleConfigProto.GoodsExchangeRuleProto.require_vip_level", "requireVipLevel", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			if (hasCostGoods) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, cost_goods$field);
			}
			for (var obtainGoods$index:uint = 0; obtainGoods$index < this.obtainGoods.length; ++obtainGoods$index) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 3);
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, this.obtainGoods[obtainGoods$index]);
			}
			for (var detailGoods$index:uint = 0; detailGoods$index < this.detailGoods.length; ++detailGoods$index) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 4);
				com.netease.protobuf.WriteUtils.write_TYPE_MESSAGE(output, this.detailGoods[detailGoods$index]);
			}
			if (hasLimit) {
			...
			if (hasLimitType) {
				...
				com.netease.protobuf.WriteUtils.write_TYPE_INT32(output, limit_type$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					...
					com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, this.costGoods);
					break;
				case 3:
					this.obtainGoods.push(com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, new app.message.GoodsWrapperProto()));
					break;
				case 4:
					this.detailGoods.push(com.netease.protobuf.ReadUtils.read_TYPE_MESSAGE(input, new app.message.GoodsWrapperProto()));
					break;
				case 5:
					if (limit$count != 0) {
				...
				case 6:
					...
					++limit_type$count;
					this.limitType = com.netease.protobuf.ReadUtils.read_TYPE_INT32(input);
					break;
				case 7:
