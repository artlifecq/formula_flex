...
//			this.invalidate(INVALIDATION_FLAG_STYLES);
		...
		//=========================zhuzhongmao================
		public static var SHOW_SCROLLER_WITH_SLIDER_MODE:Boolean = false;
		private var _showSliderMode:Boolean = SHOW_SCROLLER_WITH_SLIDER_MODE;
		public function set showScrollerWithSliderMode(value:Boolean):void
		{
			if(_showSliderMode != value)
			{
		...
		public static var THUMB_AUTO_RESIZE:Boolean = true;
		private var _thumbAutoResize:Boolean = THUMB_AUTO_RESIZE;
		public function set showScrollerThumbAutoResize(value:Boolean):void
		{
			if(_thumbAutoResize != value)
			{
		...
		protected function layoutChildren():void
		{
			...
			if(this.horizontalScrollBar !== null)
			{
				...
				if(this._scrollBarDisplayMode !== ScrollBarDisplayMode.FIXED)
				{
					...
					{
						this.horizontalScrollBar.width = visibleWidth - this.verticalScrollBar.width - this._scrollBarPaddingBottom;
					}
					else
					{
						this.horizontalScrollBar.width = visibleWidth - this._scrollBarPaddingBottom;
					}
				}
				else
				{
			...
			if(this.verticalScrollBar !== null)
			{
				...
				{
					this.verticalScrollBar.x = this._leftViewPortOffset + visibleWidth + this._scrollBarPaddingLeft;
				}
				...
				if(this._scrollBarDisplayMode !== ScrollBarDisplayMode.FIXED)
				{
					...
					{
						this.verticalScrollBar.height = visibleHeight - this.horizontalScrollBar.height - this._scrollBarPaddingBottom;
					}
					else
					{
						this.verticalScrollBar.height = visibleHeight - this._scrollBarPaddingBottom;
					}
				}
				else
				{
		...
		{
			if(!_horizontalAutoScrollTween)return;
		...
		{
			if(!_verticalAutoScrollTween)return;
