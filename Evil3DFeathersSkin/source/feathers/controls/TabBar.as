...
package feathers.controls
{
	...
	public class TabBar extends FeathersControl implements IFocusDisplayObject
	{
		 ...
		 * @private
		 */
		protected var _distributeTabSizes:Boolean = false;
		...
		public function getButtonByIndex(index:int):ToggleButton
		{
			return  toggleGroup.getItemByIndex(index) as ToggleButton;
		}
	}
}
