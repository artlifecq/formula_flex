...
package feathers.controls.text
{
	...
	public class TextFieldTextEditor extends FeathersControl implements ITextEditor, INativeFocusOwner, IStateObserver
	{
		 ...
		 *
		 * @default flash.text.GridFitType.NONE
		 *
		 ...
		 * @private
		 */
		private var _thickness:Number = Fontter.DEFAULT_THICKNESS;
		...
		override protected function initialize():void
		{
			...
			this.textField.addEventListener(flash.events.TextEvent.TEXT_INPUT, textField_inputHandler);
		...
		protected function commitStylesAndData(textField:TextField):void
		{
			...
			textField.thickness = Fontter.DEFAULT_THICKNESS;
			...
			textField.filters = _nativeFilters;
		...
		protected function refreshSnapshot():void
		{
			...
			var bitmapData:BitmapData = new BitmapData(this._snapshotWidth, this._snapshotHeight, true, 0);
			...
			else
			{
				...
				else
				{
					...
					var existingTexture:IStarlingTexture = this.textSnapshot.texture;
		 ...
		 * @private
		 */
		protected function textField_inputHandler(event:flash.events.TextEvent):void
		{
