...
package feathers.controls
{
	 ...
	 */
	public class TextInput extends FeathersControl implements IToggle, ITextBaselineControl, IAdvancedNativeFocusOwner, IStateContext
	{
		/**
		 * @private
		 */
		...
		{
			textEditorProperties[name] = value;
			this.invalidate(INVALIDATION_FLAG_STYLES);
		}
...
//			this.invalidate(INVALIDATION_FLAG_STYLES);
		...
		override protected function draw():void
		{
			...
			if(this.promptTextRenderer)
			{
				...
				{
					this.promptTextRenderer.visible = this._prompt && this._text.length == 0 && !this._textEditorHasFocus;
				}
		...
		protected function createTextEditor():void
		{
			if(this.textEditor)
			{
				...
				this.textEditor.removeEventListener(FeathersEventType.TEXT_INPUT, textEditor_textInputHandler);
			...
			this.textEditor.addEventListener(FeathersEventType.TEXT_INPUT, textEditor_textInputHandler);
