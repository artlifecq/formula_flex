	...
	public class List extends Scroller implements IFocusContainer
	{
		...
		public function set selectedIndex(value:int):void
		{
			...
			if(value >= 0)
			{
				...
				dispatchEventWith(Event.CHANGE, false, selectedItem);
			}
			else
			{
				this._selectedIndices.removeAll();
				this._customSelectedItemRender = null;
			}
			this.invalidate(INVALIDATION_FLAG_SELECTED);
		}
		...
		public function setSelectedItemRenderNoDispatchEvent(value:DisplayObject):void
		{
			_customSelectedItemRender = value;
		}
		...
		public function get selectedItemRender():DisplayObject
		{
			return _customSelectedItemRender;
		}
		
/*		public function set selecedtItemRender(value:DisplayObject):void
		{
			customSelectedItemRender = value;
		}*/
		...
		{
			super.scrollToPosition(0, maxVerticalScrollPosition, animationDuration);
		}
