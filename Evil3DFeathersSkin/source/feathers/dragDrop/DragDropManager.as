...
package feathers.dragDrop
{
	...
	public class DragDropManager
	{
		...
		public static function cancelDrag():void
		{
			...
			data.setDataForFormat("dropTarget", dropTarget);
			if(dropTarget)
			{
			...
			cleanup();
			source.dispatchEvent(new DragDropEvent(DragDropEvent.DRAG_CANCEL, data, false));
		}
		...
		protected static function cleanup():void
		{
			...
			var stage:Stage = DisplayObject(_dragSource).stage || _dragSourceStage;
			var starling:Starling = stage.starling;
		...
		protected static function updateDropTarget(location:Point):void
		{
			...
			var target:DisplayObject = stage!= null ? stage.hitTest(location) : null;
