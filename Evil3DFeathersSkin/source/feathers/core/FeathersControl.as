	...
	public class FeathersControl extends Sprite implements IFeathersControl, ILayoutDisplayObject
	{
		...
		public function set left(value:Number):void
		{
			if(_left == value)
				return;
			_left = value;
			invalidateAnchorLayoutData("left", value);
		}
		...
		public function set right(value:Number):void
		{
			if(_right == value)
				return;
			_right = value;
			invalidateAnchorLayoutData("right", value);
		}
		...
		public function set top(value:Number):void
		{
			if(_top == value)
				return;
			_top = value;
			invalidateAnchorLayoutData("top", value);
		}
		...
		public function set bottom(value:Number):void
		{
			if(_bottom == value)
				return;
			_bottom = value;
			invalidateAnchorLayoutData("bottom", value);
		}
		...
		public function set horizontalCenter(value:Number):void
		{
			...
			invalidateAnchorLayoutData("horizontalCenter", value);
		}
		...
		public function set verticalCenter(value:Number):void
		{
			...
			invalidateAnchorLayoutData("verticalCenter", value);
		}
		
		private function invalidateAnchorLayoutData(prop:String, value:Number):void
		{
			if(_layoutData == null)
			{
				_layoutData = new AnchorLayoutData();
			}
			_layoutData[prop] = value;
		}
