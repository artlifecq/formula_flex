...
package feathers.textures
{
	...
	/**
	 * Slices a Starling IStarlingTexture into three regions to be used by <code>Scale3Image</code>.
	 *
	 * @see feathers.display.Scale3Image
	 */
	public final class RepeatScale3Textures
	{
		/**
		 * @private
		 */
		 ...
		 * Constructor.
		 *
		 * @param texture			A Starling IStarlingTexture to slice up into three regions. It is recommended to turn of mip-maps for best rendering results.
		 ...
		 */
		public function RepeatScale3Textures(texture:IStarlingTexture, firstRegionSize:Number, secondRegionSize:Number, direction:String = DIRECTION_HORIZONTAL)
		{
		 ...
		 *
		 * @default RepeatScale3Textures.DIRECTION_HORIZONTAL
		 *
		 ...
		 * @private
		 */
		private var _first:IStarlingTexture;
		
		/**
		 * The texture for the first region.
		 */
		public function get first():IStarlingTexture
		{
			return this._first;
		}
		 ...
		 * @private
		 */
		private var _second:IStarlingTexture;
		
		/**
		 * The texture for the second region.
		 */
		public function get second():IStarlingTexture
		{
			return this._second;
		}
		 ...
		 * @private
		 */
		private var _third:IStarlingTexture;
		
		/**
		 * The texture for the third region.
		 */
		public function get third():IStarlingTexture
		{
			return this._third;
		}
		...
		private function initialize():void
		{
			...
			if(this._direction == DIRECTION_VERTICAL)
			{
				...
				this._first = TextureFactory.fromTexture(texture, firstRegion, firstFrame);
				...
				this._second = TextureFactory.fromTexture(texture, secondRegion, secondFrame);
				...
				this._third = TextureFactory.fromTexture(texture, thirdRegion, thirdFrame);
			}
			else //horizontal
			{
