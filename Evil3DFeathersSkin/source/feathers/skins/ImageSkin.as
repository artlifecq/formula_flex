...
package feathers.skins
{
	...
	public class ImageSkin extends Image implements IMeasureDisplayObject, IStateObserver
	{
		 ...
		 * Constructor.
		 */
		public function ImageSkin(defaultTexture:IStarlingTexture = null)
		{
		 ...
		 * @private
		 */
		protected var _defaultTexture:IStarlingTexture;
		 ...
		 * @see http://doc.starling-framework.org/current/starling/textures/IStarlingTexture.html starling.textures.IStarlingTexture
		 */
		public function get defaultTexture():IStarlingTexture
		{
		 ...
		 * @private
		 */
		public function set defaultTexture(value:IStarlingTexture):void
		{
		 ...
		 * @private
		 */
		protected var _disabledTexture:IStarlingTexture;
		 ...
		 * @see http://doc.starling-framework.org/current/starling/textures/IStarlingTexture.html starling.textures.IStarlingTexture
		 */
		public function get disabledTexture():IStarlingTexture
		{
		 ...
		 * @private
		 */
		public function set disabledTexture(value:IStarlingTexture):void
		{
		 ...
		 * @private
		 */
		protected var _selectedTexture:IStarlingTexture;
		 ...
		 * @see http://doc.starling-framework.org/current/starling/textures/IStarlingTexture.html starling.textures.IStarlingTexture
		 */
		public function get selectedTexture():IStarlingTexture
		{
		 ...
		 * @private
		 */
		public function set selectedTexture(value:IStarlingTexture):void
		{
		 ...
		 * <code>IStarlingTexture</code> based on the current state of that context.
		 ...
		 * @see #setTextureForState()
		 */
		public function getTextureForState(state:String):IStarlingTexture
		{
			return this._stateToTexture[state] as IStarlingTexture;
		}
		 ...
		 */
		public function setTextureForState(state:String, texture:IStarlingTexture):void
		{
			if(texture !== null)
			{
		...
		protected function updateTextureFromContext():void
		{
			...
			{
				texture = this._stateToTexture[this._stateContext.currentState] as IStarlingTexture;
				if(texture === null &&
